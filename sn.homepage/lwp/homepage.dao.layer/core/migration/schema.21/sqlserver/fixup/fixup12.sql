...
ALTER TABLE HOMEPAGE.NR_NEWS_RECORDS
	ADD TEXT_META_TEMPLATE nvarchar(max)
GO

ALTER TABLE HOMEPAGE.NR_SOURCE
	ADD IS_PRIVATE NUMERIC(5,0)
GO
...
ALTER TABLE HOMEPAGE.EMD_JOBS
	ADD JOB_FREQUENCY_SCALE nvarchar(36) NOT NULL DEFAULT ''
GO	
...
ALTER TABLE HOMEPAGE.EMD_JOBS
	ADD AVG_EXEC_TIME_SECONDS NUMERIC(10,0)
GO	
...
ALTER TABLE HOMEPAGE.EMD_JOBS_STATS
	ADD EXEC_TIME_SECONDS NUMERIC(10,0)
GO	
