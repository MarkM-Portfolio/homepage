...
INSERT INTO HOMEPAGE.HP_TAB_INST  (TAB_INST_ID, TAB_ID, UI_ID, TAB_NAME, N_COLUMNS, LAST_MODIFIED) 
	SELECT '%panel.widget_' || SUBSTR(UI.UI_ID,15), '%panel.widgetx4a43x82aaxb00187218631',UI.UI_ID, '%panel.widget',2, (CURRENT TIMESTAMP)
	FROM HOMEPAGE.HP_UI UI;

INSERT INTO HOMEPAGE.HP_TAB_INST  (TAB_INST_ID, TAB_ID, UI_ID, TAB_NAME, N_COLUMNS, LAST_MODIFIED) 
	SELECT '%panel.update_' || SUBSTR(UI.UI_ID,15), '%panel.updatex4a43x82aaxb00187218631',UI.UI_ID, '%panel.update',2, (CURRENT TIMESTAMP)                
	FROM HOMEPAGE.HP_UI UI;
