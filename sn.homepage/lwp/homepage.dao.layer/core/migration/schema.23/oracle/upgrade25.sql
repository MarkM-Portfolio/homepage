...
-- Fixing issue relating to a wrong data type
...
ALTER TABLE HOMEPAGE.WIDGET
ADD WIDGET_IS_DEFAULT_OPENED NUMBER(5,0) DEFAULT 0 NOT NULL;

ALTER TABLE HOMEPAGE.WIDGET
ADD WIDGET_MULTIPLE_INSTANCES NUMBER(5,0) DEFAULT 0 NOT NULL;

ALTER TABLE HOMEPAGE.WIDGET
ADD WIDGET_MARKED_CACHABLE  NUMBER(5,0) DEFAULT 0 NOT NULL;
