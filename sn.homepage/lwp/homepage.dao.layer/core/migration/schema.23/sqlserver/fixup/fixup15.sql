...
ALTER TABLE HOMEPAGE.NR_NEWS_RECORDS
	ADD IS_CONTAINER NUMERIC(5,0) DEFAULT 0 NOT NULL
GO
...
ALTER TABLE HOMEPAGE.NR_SOURCE
	ADD IS_CNAME_RTL NUMERIC(5,0) DEFAULT 0 NOT NULL
GO

ALTER TABLE HOMEPAGE.NR_SOURCE
	ADD IS_ENAME_RTL NUMERIC(5,0) DEFAULT 0 NOT NULL
GO
...
ALTER TABLE HOMEPAGE.NR_SUBSCRIPTION
	ADD IS_ACTIVE NUMERIC(5,0) DEFAULT 1 NOT NULL
GO
...
ALTER TABLE HOMEPAGE.EMD_JOBS_STATS
	ADD STATUS nvarchar(36) DEFAULT 'COMPLETED' NOT NULL
GO
...
ALTER TABLE HOMEPAGE.SR_TASKDEF
	ADD ENABLED NUMERIC(5,0) DEFAULT 1 NOT NULL
GO	
...
ALTER TABLE HOMEPAGE.SR_FILESCONTENT
	ADD CLAIMED NUMERIC(5,0) DEFAULT 0 NOT NULL
GO

ALTER TABLE HOMEPAGE.SR_FILESCONTENT
	ADD CLAIMED_TIME TIMESTAMP NOT NULL
GO
