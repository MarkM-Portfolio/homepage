...
DROP FOREIGN KEY "FK_PREREQ_WIDGET";

ALTER TABLE HOMEPAGE.USER_WIDGET_PREF 
DROP FOREIGN KEY "FK_WIDGET_ID";


-- Update the WIDGET_ID - WIDGET TABLE
update  HOMEPAGE.WIDGET WIDGET
set     WIDGET.WIDGET_ID = SUBSTR('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', (LENGTH(WIDGET_ID)+1) ) || WIDGET.WIDGET_ID
where   LENGTH(WIDGET.WIDGET_ID) < 30;

COMMIT;

-- Update the WIDGET_ID - USER_WIDGET_PREF
update  HOMEPAGE.USER_WIDGET_PREF USER_WIDGET_PREF
set     USER_WIDGET_PREF.WIDGET_ID =  SUBSTR('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', (LENGTH(WIDGET_ID)+1) ) || USER_WIDGET_PREF.WIDGET_ID
where   LENGTH(USER_WIDGET_PREF.WIDGET_ID) < 30;

COMMIT;

-- Update the WIDGET_ID - PREREQ
update  HOMEPAGE.PREREQ PREREQ
set     PREREQ.WIDGET_ID = SUBSTR('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', (LENGTH(WIDGET_ID)+1) ) ||  PREREQ.WIDGET_ID
where   LENGTH(PREREQ.WIDGET_ID) < 30;
...
INSERT INTO HOMEPAGE.HP_WIDGET_TAB  (WIDGET_TAB_ID, WIDGET_ID, TAB_ID, TYPE) 
	SELECT 'WIDGET_OTHERS_' || SUBSTR(WIDGET.WIDGET_ID,15), WIDGET.WIDGET_ID, '_panel.widgetx4a43x82aaxb00187218631','primary'
