...
ALTER COLUMN INPUT_MIME_TYPE SET DATA TYPE VARCHAR(256);
...
ADD COLUMN WIDGET_SECURE_URL VARCHAR(256) DEFAULT '';

ALTER TABLE HOMEPAGE.WIDGET
ADD COLUMN WIDGET_SECURE_ICON VARCHAR(256) DEFAULT '';
