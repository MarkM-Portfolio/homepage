...
UPDATE  HOMEPAGE.HP_TAB 		SET TAB_ID = '_' || SUBSTR(TAB_ID,2);
UPDATE  HOMEPAGE.HP_WIDGET_TAB 	SET TAB_ID = '_' || SUBSTR(TAB_ID,2);
UPDATE  HOMEPAGE.HP_TAB_INST 	SET TAB_INST_ID = '_' || SUBSTR(TAB_INST_ID,2);
UPDATE  HOMEPAGE.HP_TAB_INST 	SET TAB_ID = '_' || SUBSTR(TAB_ID,2);
UPDATE  HOMEPAGE.HP_WIDGET_INST SET TAB_INST_ID = '_' || SUBSTR(TAB_INST_ID,2);
