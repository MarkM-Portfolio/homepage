...
ALTER TABLE HOMEPAGE.NR_NEWS_RECORDS
	ADD TEXT_META_TEMPLATE CLOB;

ALTER TABLE HOMEPAGE.NR_SOURCE
	ADD IS_PRIVATE NUMBER(5,0);
...
CREATE INDEX "HOMEPAGE"."NR_READER_IS_TOP_STORY_IDX"
	ON HOMEPAGE.NR_NEWS_RECORDS ("READER_ID", "IS_TOP_STORY") TABLESPACE "NEWSINDEXTABSPACE";

CREATE INDEX "HOMEPAGE"."NR_READER_IS_SAVED_IDX"
	ON HOMEPAGE.NR_NEWS_RECORDS ("READER_ID", "IS_SAVED") TABLESPACE "NEWSINDEXTABSPACE";
...
ALTER TABLE HOMEPAGE.EMD_JOBS
	ADD JOB_FREQUENCY_SCALE VARCHAR2(36) DEFAULT '' NOT NULL;
...
ALTER TABLE HOMEPAGE.EMD_JOBS
	ADD AVG_EXEC_TIME_SECONDS NUMBER(10,0);
...
ALTER TABLE HOMEPAGE.EMD_JOBS_STATS
	ADD EXEC_TIME_SECONDS NUMBER(10,0);
...
CREATE TABLE HOMEPAGE.SR_TASKDEF (
	...
	STARTBY VARCHAR2(256) NOT NULL,
	INTERVAL VARCHAR2(256) NOT NULL,
...
--dbcompartor fixing minor issue
ALTER TABLE HOMEPAGE.EMD_JOBS 
MODIFY JOB_FREQUENCY_SCALE DEFAULT null;

ALTER TABLE HOMEPAGE.NT_NOTIFICATION_RECIPIENT
MODIFY RECIPIENT_EXID VARCHAR2(36);
