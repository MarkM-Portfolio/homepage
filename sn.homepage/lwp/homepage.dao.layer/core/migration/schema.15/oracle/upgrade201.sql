...
--------------------------------------
ALTER TABLE HOMEPAGE.PREREQ DROP CONSTRAINT PREREQ_WIDGET_FK;

ALTER TABLE HOMEPAGE.PREREQ DROP PRIMARY KEY;

ALTER TABLE HOMEPAGE.WIDGET DROP PRIMARY KEY;

-----------------------------------------------------------------------------------------------------
-- WORKING ON HOMEPAGE.PERSON
-----------------------------------------------------------------------------------------------------
-- adding PERSON_ID column
ALTER TABLE HOMEPAGE.PERSON ADD PERSON_ID VARCHAR2(36);
UPDATE HOMEPAGE.PERSON SET  PERSON_ID=' ';
ALTER TABLE HOMEPAGE.PERSON  MODIFY PERSON_ID NOT NULL;

-- adding DISPLAYNAME column
ALTER TABLE HOMEPAGE.PERSON ADD DISPLAYNAME VARCHAR2(256);
UPDATE HOMEPAGE.PERSON SET  DISPLAYNAME=' ';
ALTER TABLE HOMEPAGE.PERSON  MODIFY DISPLAYNAME NOT NULL;

-- adding SHOW_DISABLED_WIDGETS column
ALTER TABLE HOMEPAGE.PERSON ADD SHOW_DISABLED_WIDGETS NUMBER(1);
UPDATE HOMEPAGE.PERSON SET  SHOW_DISABLED_WIDGETS=0;
ALTER TABLE HOMEPAGE.PERSON  MODIFY SHOW_DISABLED_WIDGETS NOT NULL;

-- USER_MAIL can now be even NULL
ALTER TABLE HOMEPAGE.PERSON MODIFY USER_MAIL VARCHAR2(256) NULL;

-- copy USER_ID in PERSON_ID
UPDATE HOMEPAGE.PERSON  	
SET HOMEPAGE.PERSON.PERSON_ID = 	( SELECT PERSON_A.USER_ID
FROM HOMEPAGE.PERSON PERSON_A
WHERE PERSON_A.USER_ID = HOMEPAGE.PERSON.USER_ID )
WHERE EXISTS
  ( SELECT PERSON_B.USER_ID
    FROM HOMEPAGE.PERSON PERSON_B
...
ALTER TABLE "HOMEPAGE"."PERSON" ADD (CONSTRAINT "PK_PERSON_ID" PRIMARY KEY ("PERSON_ID") USING INDEX TABLESPACE "HOMEPAGEINDEXTABSPACE");
...
ALTER TABLE HOMEPAGE.USER_WIDGET_PREF ADD TEMP_USER_ID VARCHAR2(36);

UPDATE HOMEPAGE.USER_WIDGET_PREF  	
SET HOMEPAGE.USER_WIDGET_PREF.TEMP_USER_ID = 	( SELECT USER_WIDGET_PREF_A.USER_ID
FROM HOMEPAGE.USER_WIDGET_PREF USER_WIDGET_PREF_A
...
WHERE EXISTS
  ( SELECT USER_WIDGET_PREF_B.USER_WIDGET_PREF_ID
    FROM HOMEPAGE.USER_WIDGET_PREF USER_WIDGET_PREF_B
...
ALTER TABLE HOMEPAGE.USER_WIDGET_PREF ADD USER_ID VARCHAR2(36);
UPDATE HOMEPAGE.USER_WIDGET_PREF SET  USER_ID=' ';
ALTER TABLE HOMEPAGE.USER_WIDGET_PREF  MODIFY USER_ID NOT NULL;
