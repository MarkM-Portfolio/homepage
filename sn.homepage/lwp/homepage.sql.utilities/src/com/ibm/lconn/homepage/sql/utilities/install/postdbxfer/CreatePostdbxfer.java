...
public class CreatePostdbxfer {

	private static String CLASS_NAME = CreatePostdbxfer.class.getName();
	...
	public static void main (String args[]) throws Exception{
		...
		CreatePostdbxfer createPredbxfer = new CreatePostdbxfer();
	...
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new CreatePostdbxferDB2());
		UtilityIO.generate(props, conn, new CreatePostdbxferOracle());
		UtilityIO.generate(props, conn, new CreatePostdbxferSQL());
	}
