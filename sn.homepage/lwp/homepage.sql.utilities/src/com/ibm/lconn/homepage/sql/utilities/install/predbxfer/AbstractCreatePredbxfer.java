...
public abstract class AbstractCreatePredbxfer  implements ICreatePredbxfer {

	private static String CLASS_NAME = AbstractCreatePredbxfer.class.getName();
	private static Logger logger = Logger.getLogger(CLASS_NAME);
	
	public static String FILE_NAME = "predbxfer60.sql";
	...
	public abstract List<String> dropFK(Connection conn, StringBuffer sb) throws Exception;
	
	public abstract List<String> removeRecords(Connection conn, StringBuffer sb) throws Exception;
