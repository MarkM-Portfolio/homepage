...
public class UpdateStats {
	...
	private static String CLASS_NAME = UpdateStats.class.getName();
	...
	public static void main (String args[]) throws Exception{
		...
		UpdateStats createPredbxfer = new UpdateStats();
	...
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new UpdateStatsDB2());
		UtilityIO.generate(props, conn, new UpdateStatsOracle());
		UtilityIO.generate(props, conn, new UpdateStatsSQL());
	}
