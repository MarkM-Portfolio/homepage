...
public class UpdateStatsDB2 extends AbstractCreateUpdateStats implements IUpdateStats {
	...
	public List<String> updateStats(Connection conn, StringBuffer sb) throws Exception  {
		...
		for (String table: tables) {
			String statment = "runstats on table "+table+" with distribution and detailed indexes all allow write access@\nCOMMIT@\n";
			sb.append(statment);
			stats.add(statment);
