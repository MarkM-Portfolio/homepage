...
package com.ibm.lconn.homepage.sql.generator.indexes.fixup468.containerId;
...
public class IndexGeneratorReaders {
	...
	private static final String[] indexes_names = { 
		...
		"CONT_IDX"// all tables to support soft delete
	};
	...
	private static final String[] indexes = {
		...
		"(READER_ID, ROLLUP_ENTRY_ID, IS_VISIBLE, CREATION_DATE DESC)", //7 ROLLUP_IIX
