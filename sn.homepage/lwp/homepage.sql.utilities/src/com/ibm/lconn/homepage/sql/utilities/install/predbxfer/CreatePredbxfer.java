...
public class CreatePredbxfer {

	private static String CLASS_NAME = CreatePredbxfer.class.getName();
	...
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new CreatePredbxferDB2());
		UtilityIO.generate(props, conn, new CreatePredbxferOracle());
		UtilityIO.generate(props, conn, new CreatePredbxferSQL());
	}
