...
public class CreateAppGrantsDB2 extends AbstractCreateAppGrants implements ICreateAppGrants {
	
	private static String CLASS_NAME = CreateAppGrantsDB2.class.getName();
	...
	public List<String> grants(Connection conn, StringBuffer sb)
		...
		for (String tabName : tables) {
			...
			String statment = "GRANT DELETE,INSERT,SELECT,UPDATE ON " + tableName + " TO USER LCUSER@\nCOMMIT@\n";	
			sb.append(statment);
		    drops.add(statment);		    
		}
		return drops;	
