...
public abstract class AbstractReorg  implements IReorg {

	private static String CLASS_NAME = AbstractReorg.class.getName();
	private static Logger logger = Logger.getLogger(CLASS_NAME);
	
	public static String FILE_NAME = "reorg.sql";
	...
	public abstract List<String> reorg(Connection conn, StringBuffer sb) throws Exception;
