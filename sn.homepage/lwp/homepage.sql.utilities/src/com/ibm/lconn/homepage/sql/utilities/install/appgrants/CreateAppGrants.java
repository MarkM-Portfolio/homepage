...
public class CreateAppGrants {

	private static String CLASS_NAME = CreateAppGrants.class.getName();
	...
	public static void main (String args[]) throws Exception{
		...
		createAppGrants.generate(propJDBC, conn);	
	}
	
	/** Put here the obj to generate */
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new CreateAppGrantsDB2());
		UtilityIO.generate(props, conn, new CreateAppGrantsOracle());
		UtilityIO.generate(props, conn, new CreateAppGrantsSQL());
	}
