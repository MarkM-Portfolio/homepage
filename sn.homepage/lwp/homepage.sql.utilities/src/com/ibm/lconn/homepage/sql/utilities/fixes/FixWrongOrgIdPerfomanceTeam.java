...
public class FixWrongOrgIdPerfomanceTeam {
	...
	public static void main(String[] args) throws Exception {
		...
		FixWrongOrgIdPerfomanceTeam setNotNullOrgId = new FixWrongOrgIdPerfomanceTeam();
	...
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new FixWrongOrgIdPerfomanceTeamDB2());
