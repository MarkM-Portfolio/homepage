...
package com.ibm.lconn.homepage.sql.generator.indexes;
...
public class IndexGeneratorReaders {
	...
	private static final String[] indexes = {
		...
		"(READER_ID, ORGANIZATION_ID,  USE_IN_ROLLUP,  IS_VISIBLE, IS_BROADCAST,  CREATION_DATE DESC,  ROLLUP_ENTRY_ID,  SOURCE_TYPE, STORY_ID)", //4
		"(READER_ID, IS_VISIBLE, USE_IN_ROLLUP)", // 5	
		"(STORY_ID, READER_ID)", // 6
