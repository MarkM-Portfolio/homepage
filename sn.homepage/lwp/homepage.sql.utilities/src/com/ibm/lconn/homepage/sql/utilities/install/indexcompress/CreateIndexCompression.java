...
public class CreateIndexCompression {

	private static String CLASS_NAME = CreateIndexCompression.class.getName();
	...
	public static void main (String args[]) throws Exception{
		...
		CreateIndexCompression createPredbxfer = new CreateIndexCompression();
	...
	public void generate(Properties props, Connection conn) throws Exception {
		UtilityIO.generate(props, conn, new CreateIndexCompressionDB2());
	}
