 ...
 *
 */
public class MBeanExporterImpl implements MBeanExporter {

	private final static String CLASS_NAME = MBeanExporterImpl.class.getName();
...
//    		if (logger.isLoggable(FINER))
//    			logger.log(FINER, "retrived existing mbean server");
//        } else {
//        	mbs=ManagementFactory.getPlatformMBeanServer();
//    		if (logger.isLoggable(FINER))
//    			logger.log(FINER, "created new mbean server");
//        }
        ...
        if (mbs !=null){
    		if (logger.isLoggable(FINER))
			{
	            logger.log( FINER, "default domain is " + mbs.getDefaultDomain());
    	        logger.log( FINER, "MBean count: " + mbs.getMBeanCount());
			}
        }
