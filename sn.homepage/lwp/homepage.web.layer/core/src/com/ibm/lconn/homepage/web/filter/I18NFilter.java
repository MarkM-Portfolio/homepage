...
public class I18NFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		LCServletRequest lcRequest = new LCServletRequest(
	...
	/*
	 * Added to provide a fix for 'nb-no' and 'nn-no' locales and point to 'no'
	 * resources. IE 7 appears to have a bug where Norwegian is represented by
	 * these non-standard identifiers.
	 */
	public class LCServletRequest extends HttpServletRequestWrapper {
		...
		public Locale getLocale() {
			...
			if (locale != null
					&& (locale.getLanguage().equals(nb) || locale.getLanguage()
							.equals(nn))) {
		...
		public Enumeration getLocales() {
			...
			if (acceptLanguages != null
					&& (acceptLanguages.contains("nb") || acceptLanguages
							.contains("nn"))) {
				...
				while (currentLocales.hasMoreElements()) {
					...
					if (locale != null
							&& (locale.getLanguage().equals(nb) || locale
									.getLanguage().equals(nn))) {
