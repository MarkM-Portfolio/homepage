...
ALTER COLUMN BRIEF_DESC SET DATA TYPE VARCHAR(512);

-------------------------------------------------------------------------------
-- Alter table HOMEPAGE.WIDGET and set WIDGET_CATEGORY to NOT NULL DEFAULT ' ';
-------------------------------------------------------------------------------
ALTER  TABLE HOMEPAGE.WIDGET 
ALTER COLUMN WIDGET_CATEGORY SET  DEFAULT ' ';
