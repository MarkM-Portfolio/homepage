...
COMMIT;
ALTER TABLE HOMEPAGE.EMD_RESOURCE_PREF ADD CONSTRAINT FK_RES_FRQ_TYPE FOREIGN KEY (FREQUENCY_TYPE) REFERENCES HOMEPAGE.EMD_FREQUENCY_TYPE (FREQUENCY_TYPE) ;
COMMIT;
...
COMMIT;
ALTER TABLE HOMEPAGE.NR_RESOURCE ADD CONSTRAINT FK_RES_CAT_TYPE FOREIGN KEY (CATEGORY_TYPE) REFERENCES HOMEPAGE.NR_CATEGORY_TYPE (CATEGORY_TYPE) ;
COMMIT;
ALTER TABLE HOMEPAGE.NR_RESOURCE ADD CONSTRAINT FK_RES_RES_TYPE FOREIGN KEY (RESOURCE_TYPE) REFERENCES HOMEPAGE.NR_RESOURCE_TYPE (RESOURCE_TYPE) ;
COMMIT;
...
COMMIT;
ALTER TABLE HOMEPAGE.SR_NUMBER_STATS ADD CONSTRAINT FK_NUM_STAT_ID FOREIGN KEY (STAT_ID) REFERENCES HOMEPAGE.SR_STATS (STAT_ID)  ON DELETE CASCADE;
COMMIT;
...
COMMIT;
ALTER TABLE HOMEPAGE.SR_STRING_STATS ADD CONSTRAINT FK_STR_STAT_ID FOREIGN KEY (STAT_ID) REFERENCES HOMEPAGE.SR_STATS (STAT_ID)  ON DELETE CASCADE;
COMMIT;
ALTER TABLE HOMEPAGE.SR_TIMER_STATS ADD CONSTRAINT FK_TMR_STAT_ID FOREIGN KEY (STAT_ID) REFERENCES HOMEPAGE.SR_STATS (STAT_ID)  ON DELETE CASCADE;
COMMIT;
