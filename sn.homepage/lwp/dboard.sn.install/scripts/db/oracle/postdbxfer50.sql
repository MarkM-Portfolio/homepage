...
CREATE  INDEX HOMEPAGE.AGGREGATED_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_AGGREGATED_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.AGGREGATED_READERS_STR_RDR 
 	ON HOMEPAGE.NR_AGGREGATED_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.RESPONSES_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_RESPONSES_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.RESPONSES_READERS_STR_RDR 
 	ON HOMEPAGE.NR_RESPONSES_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.RESPONSES_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_RESPONSES_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.PROFILES_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_PROFILES_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.PROFILES_READERS_STR_RDR 
 	ON HOMEPAGE.NR_PROFILES_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.PROFILES_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_PROFILES_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.COMM_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_COMMUNITIES_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.COMM_READERS_STR_RDR 
 	ON HOMEPAGE.NR_COMMUNITIES_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.COMM_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_COMMUNITIES_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.ACTIVITIES_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_ACTIVITIES_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.ACTIVITIES_READERS_STR_RDR 
 	ON HOMEPAGE.NR_ACTIVITIES_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.ACTIVITIES_READERS_RLL_BRD_VVI 
 	ON HOMEPAGE.NR_ACTIVITIES_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.BLOGS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_BLOGS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.BLOGS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_BLOGS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.BLOGS_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_BLOGS_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.BOOKMARKS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_BOOKMARKS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.BOOKMARKS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_BOOKMARKS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.BOOKMARKS_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_BOOKMARKS_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.FILES_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_FILES_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.FILES_READERS_STR_RDR 
 	ON HOMEPAGE.NR_FILES_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.FILES_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_FILES_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.FORUMS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_FORUMS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.FORUMS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_FORUMS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.FORUMS_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_FORUMS_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.WIKIS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_WIKIS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.WIKIS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_WIKIS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.WIKIS_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_WIKIS_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.TAGS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_TAGS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.TAGS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_TAGS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.TAGS_READERS_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_TAGS_READERS (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.STATUS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_STATUS_UPDATE_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.STATUS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_STATUS_UPDATE_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.EXTERNAL_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_EXTERNAL_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.EXTERNAL_READERS_STR_RDR 
 	ON HOMEPAGE.NR_EXTERNAL_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.ACTIONABLE_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_ACTIONABLE_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.ACTIONABLE_READERS_STR_RDR 
 	ON HOMEPAGE.NR_ACTIONABLE_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.DISCOVERY_VIEW_RLL_IIX 
 	ON HOMEPAGE.NR_DISCOVERY_VIEW (USE_IN_ROLLUP, ORGANIZATION_ID, IS_VISIBLE, CREATION_DATE DESC,  IS_BROADCAST, ROLLUP_ENTRY_ID, SOURCE_TYPE, STORY_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.DISCOVERY_VIEW_RLL_BRD_VVIS 
 	ON HOMEPAGE.NR_DISCOVERY_VIEW (ROLLUP_AUTHOR_ID, IS_BROADCAST, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

--NEW ORG_ID NR_DISCOVERY_VIEW 
CREATE  INDEX HOMEPAGE.DISCOVERY_VIEW_ORG_IIDX 
 	ON HOMEPAGE.NR_DISCOVERY_VIEW (ORGANIZATION_ID, IS_VISIBLE, IS_BROADCAST, ROLLUP_ENTRY_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.DISCOVERY_VIEW_COM 
 	ON HOMEPAGE.NR_DISCOVERY_VIEW (IS_STORY_COMM, ORGANIZATION_ID, IS_VISIBLE, USE_IN_ROLLUP, CREATION_DATE DESC, IS_BROADCAST, ROLLUP_ENTRY_ID, SOURCE_TYPE, STORY_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.DISCOVERY_VIEW_ACT_CD_VIS_IDX 
 	ON HOMEPAGE.NR_DISCOVERY_VIEW (ACTOR_UUID, IS_VISIBLE, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.PROFILES_VIEW_RLL_IIX 
 	ON HOMEPAGE.NR_PROFILES_VIEW (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.PROFILES_VIEW_STR_RDR 
 	ON HOMEPAGE.NR_PROFILES_VIEW (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.NOTIFICA_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_NOTIFICATION_SENT_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.NOTIFICA_READERS_STR_RDR 
 	ON HOMEPAGE.NR_NOTIFICATION_SENT_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.NOT_REC_READERS_STR_RDR 
 	ON HOMEPAGE.NR_NOTIFICATION_RECEIV_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.SAVED_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_SAVED_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.TOPICS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_TOPICS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.TOPICS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_TOPICS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.MENTIONS_READERS_RLL_IIX 
 	ON HOMEPAGE.NR_MENTIONS_READERS (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;

CREATE  INDEX HOMEPAGE.MENTIONS_READERS_STR_RDR 
 	ON HOMEPAGE.NR_MENTIONS_READERS (STORY_ID, READER_ID) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
...
CREATE  INDEX HOMEPAGE.COMMUNITIES_VIEW_RLL_IIX 
 	ON HOMEPAGE.NR_COMMUNITIES_VIEW (READER_ID, IS_VISIBLE, ORGANIZATION_ID, CREATION_DATE DESC) TABLESPACE  NEWSINDEXTABSPACE; 
COMMIT;
