...
-- This is because in fixup107 we remove it. In this way we are consistent when running fixup and upgrade scripts.
...
CREATE INDEX HOMEPAGE.MIG_STORIES_ITEM_CD
	ON HOMEPAGE.NR_STORIES (ITEM_ID, CREATION_DATE DESC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

-- not needed
--CREATE INDEX HOMEPAGE.MIG_STORIES_ITEM_ID ON
--	HOMEPAGE.NR_STORIES (ITEM_ID)  TABLESPACE "NEWSINDEXTABSPACE";
--COMMIT;
...
--	ON HOMEPAGE.PERSON  (EXID, PERSON_ID)  TABLESPACE "NEWSINDEXTABSPACE";
--COMMIT;

CREATE INDEX HOMEPAGE.MIG_NOT_READS 
	ON HOMEPAGE.NT_NOTIFICATION (IS_DELETED,  NOTIFICATION_ID)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;
...
--  [start indexes] NR_AGGREGATED_READERS
CREATE INDEX HOMEPAGE.AGGREGATED_READERS_MIG_IX ON HOMEPAGE.NR_AGGREGATED_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_AGGREGATED_READERS

--  [start indexes] NR_RESPONSES_READERS
CREATE INDEX HOMEPAGE.RESPONSES_READERS_MIG_IX ON HOMEPAGE.NR_RESPONSES_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_RESPONSES_READERS

--  [start indexes] NR_PROFILES_READERS
CREATE INDEX HOMEPAGE.PROFILES_READERS_MIG_IX ON HOMEPAGE.NR_PROFILES_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_PROFILES_READERS

--  [start indexes] NR_COMMUNITIES_READERS
CREATE INDEX HOMEPAGE.COMM_READERS_MIG_IX ON HOMEPAGE.NR_COMMUNITIES_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_COMMUNITIES_READERS

--  [start indexes] NR_ACTIVITIES_READERS
CREATE INDEX HOMEPAGE.ACTIVITIES_READERS_MIG_IX ON HOMEPAGE.NR_ACTIVITIES_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_ACTIVITIES_READERS

--  [start indexes] NR_BLOGS_READERS
CREATE INDEX HOMEPAGE.BLOGS_READERS_MIG_IX ON HOMEPAGE.NR_BLOGS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_BLOGS_READERS

--  [start indexes] NR_BOOKMARKS_READERS
CREATE INDEX HOMEPAGE.BOOKMARKS_READERS_MIG_IX ON HOMEPAGE.NR_BOOKMARKS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_BOOKMARKS_READERS

--  [start indexes] NR_FILES_READERS
CREATE INDEX HOMEPAGE.FILES_READERS_MIG_IX ON HOMEPAGE.NR_FILES_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_FILES_READERS

--  [start indexes] NR_FORUMS_READERS
CREATE INDEX HOMEPAGE.FORUMS_READERS_MIG_IX ON HOMEPAGE.NR_FORUMS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_FORUMS_READERS

--  [start indexes] NR_WIKIS_READERS
CREATE INDEX HOMEPAGE.WIKIS_READERS_MIG_IX ON HOMEPAGE.NR_WIKIS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_WIKIS_READERS

--  [start indexes] NR_TAGS_READERS
CREATE INDEX HOMEPAGE.TAGS_READERS_MIG_IX ON HOMEPAGE.NR_TAGS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_TAGS_READERS

--  [start indexes] NR_STATUS_UPDATE_READERS
CREATE INDEX HOMEPAGE.STATUS_READERS_MIG_IX ON HOMEPAGE.NR_STATUS_UPDATE_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_STATUS_UPDATE_READERS

--  [start indexes] NR_EXTERNAL_READERS
CREATE INDEX HOMEPAGE.EXTERNAL_READERS_MIG_IX ON HOMEPAGE.NR_EXTERNAL_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_EXTERNAL_READERS

--  [start indexes] NR_ACTIONABLE_READERS
CREATE INDEX HOMEPAGE.ACTIONABLE_READERS_MIG_IX ON HOMEPAGE.NR_ACTIONABLE_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;
...
--  [start indexes] NR_DISCOVERY_VIEW
CREATE INDEX HOMEPAGE.DISCOVERY_VIEW_MIG_IX ON HOMEPAGE.NR_DISCOVERY_VIEW (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_DISCOVERY_VIEW

--  [start indexes] NR_PROFILES_VIEW
CREATE INDEX HOMEPAGE.PROFILES_VIEW_MIG_IX ON HOMEPAGE.NR_PROFILES_VIEW (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_PROFILES_VIEW

--  [start indexes] NR_NOTIFICATION_SENT_READERS
CREATE INDEX HOMEPAGE.NOTIFICA_READERS_MIG_IX ON HOMEPAGE.NR_NOTIFICATION_SENT_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_NOTIFICATION_SENT_READERS

--  [start indexes] NR_NOTIFICATION_RECEIV_READERS
CREATE INDEX HOMEPAGE.NOT_REC_READERS_MIG_IX ON HOMEPAGE.NR_NOTIFICATION_RECEIV_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_NOTIFICATION_RECEIV_READERS

--  [start indexes] NR_SAVED_READERS
CREATE INDEX HOMEPAGE.SAVED_READERS_MIG_IX ON HOMEPAGE.NR_SAVED_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;

--  [end indexes] NR_SAVED_READERS

--  [start indexes] NR_TOPICS_READERS
CREATE INDEX HOMEPAGE.TOPICS_READERS_MIG_IX ON HOMEPAGE.NR_TOPICS_READERS (READER_ID, ROLLUP_ENTRY_ID, CREATION_DATE ASC)  TABLESPACE "NEWSINDEXTABSPACE";
COMMIT;
...
CREATE UNIQUE INDEX HOMEPAGE.MIG_RLL_STORY_IDX  
   ON HOMEPAGE.NR_STORIES (STORY_ID, ITEM_ID, ITEM_CORRELATION_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE UNIQUE INDEX HOMEPAGE.MIG_STR_CORR 
	ON HOMEPAGE.NR_STORIES (STORY_ID, ITEM_CORRELATION_ID) TABLESPACE "NEWSINDEXTABSPACE";
