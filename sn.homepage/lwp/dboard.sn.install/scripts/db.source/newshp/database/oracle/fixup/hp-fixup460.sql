...
ALTER TABLE HOMEPAGE.PERSON ADD PREF_LANG VARCHAR2(5);
COMMIT;

--------------------------------------------------------------
-- 98833: [fixup460] Update tables for highway
--------------------------------------------------------------
ALTER TABLE HOMEPAGE.MT_CFG_SETTINGS ADD ROLE VARCHAR2(36);
COMMIT;

ALTER TABLE HOMEPAGE.MT_CFG_DEFINITIONS ADD ALLOW_ROLE NUMBER(5, 0);
COMMIT;
