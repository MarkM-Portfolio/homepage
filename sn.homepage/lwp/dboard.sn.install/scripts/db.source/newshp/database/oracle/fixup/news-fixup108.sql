...
CREATE INDEX HOMEPAGE.STORIES_ITEM_ENTRY_CORR_ID
    ON HOMEPAGE.NR_STORIES (ENTRY_CORRELATION_ID)  TABLESPACE  NEWSINDEXTABSPACE; 
    
COMMIT;    
    
--74742: [Performance] AS crawling / indexing is extremely slow 
CREATE INDEX HOMEPAGE.NR_AS_SEEDLIST_IDX 
	ON HOMEPAGE.NR_AS_SEEDLIST (UPDATE_DATE DESC, STORY_ID, IS_DELETED, IS_VISIBLE) TABLESPACE  NEWSINDEXTABSPACE;
