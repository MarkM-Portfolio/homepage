...
CREATE INDEX HOMEPAGE.NR_NEWS_SC_ITEM_COR
    ON HOMEPAGE.NR_NEWS_STATUS_COMMENT (ITEM_CORRELATION_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_NEWS_SN_READER_FOLL
    ON HOMEPAGE.NR_NEWS_STATUS_NETWORK (CREATION_DATE DESC, READER_ID, IS_FOLLOW_NEWS) TABLESPACE "NEWSINDEXTABSPACE";

CREATE INDEX HOMEPAGE.NR_NEWS_SN_READER_NETW
    ON HOMEPAGE.NR_NEWS_STATUS_NETWORK (CREATION_DATE DESC, READER_ID, IS_NETWORK_NEWS) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_NEWS_STATUS_NETWORK_READER
    ON HOMEPAGE.NR_NEWS_STATUS_NETWORK (CREATION_DATE DESC, READER_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_NEWS_SAVED_READER
    ON HOMEPAGE.NR_NEWS_SAVED (CREATION_DATE DESC, READER_ID) TABLESPACE "NEWSINDEXTABSPACE";

CREATE INDEX HOMEPAGE.NR_NEWS_SAVED_READER_SRC
    ON HOMEPAGE.NR_NEWS_SAVED (CREATION_DATE DESC, READER_ID, SOURCE) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_NEWS_DISCOVERY_CREAT
    ON HOMEPAGE.NR_NEWS_DISCOVERY (CREATION_DATE DESC) TABLESPACE "NEWSINDEXTABSPACE";

CREATE INDEX HOMEPAGE.NR_NEWS_DISCOVERY_CREAT_SOURCE
    ON HOMEPAGE.NR_NEWS_DISCOVERY (CREATION_DATE DESC, SOURCE) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_FOLLOWED_STORIES_READER
    ON HOMEPAGE.NR_FOLLOWED_STORIES (CREATION_DATE ASC, READER_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_FS_READER_CONT
    ON HOMEPAGE.NR_FOLLOWED_STORIES (CREATION_DATE ASC, READER_ID, CONTAINER_ID) TABLESPACE "NEWSINDEXTABSPACE";

CREATE INDEX HOMEPAGE.NR_FOLLOWED_STORIES_STORY_ID
    ON HOMEPAGE.NR_FOLLOWED_STORIES (STORY_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_ORGPERSON_FOLLOW_PERSON_ID
    ON HOMEPAGE.NR_ORGPERSON_FOLLOW (PERSON_ID) TABLESPACE "NEWSINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NR_ORGPERSON_STORIES_STORY_ID
    ON HOMEPAGE.NR_ORGPERSON_STORIES (STORY_ID) TABLESPACE "NEWSINDEXTABSPACE";
