...
{ORA_GRANT_START} HOMEPAGE.NR_GROUP_TYPE {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_GROUP {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_PERSON_SOURCE {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_GROUP_SOURCE {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_CATEGORY_TYPE {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_CATEGORY {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_SOURCE_WATCHED {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_FOLLOW {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_FOLLOW_GROUP {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_TOP_UPDATES {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_SAVED {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_DISCOVERY {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_WATCHLIST {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_STATUS_NETWORK {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_STORY {ORA_GRANT_STOP}
{ORA_GRANT_START} HOMEPAGE.NR_NEWS_COMMENT {ORA_GRANT_STOP}
...
SELECT  '-' || SUBSTR((NR_CATEGORY_TYPE.CATEGORY_TYPE_NAME || PERSON.PERSON_ID),2,LENGTH(PERSON.PERSON_ID)-2) CATEGORY_ID,
        PERSON.PERSON_ID, 
