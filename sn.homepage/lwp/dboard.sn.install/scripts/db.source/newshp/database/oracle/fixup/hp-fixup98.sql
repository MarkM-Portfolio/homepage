...
CREATE TABLE HOMEPAGE.OAUTH1_CLIENT (
	ID VARCHAR2(254) NOT NULL PRIMARY KEY USING INDEX  TABLESPACE "NEWSINDEXTABSPACE",
	NAME VARCHAR2(254) NOT NULL,
	TOKENID VARCHAR2(254) NOT NULL,
	PROVIDERID VARCHAR2(254) NOT NULL,
	DESCRIPTION VARCHAR2(1024),
...
CREATE TABLE HOMEPAGE.OAUTH1_CONTEXT (
	ID VARCHAR2(254) NOT NULL PRIMARY KEY USING INDEX  TABLESPACE "NEWSINDEXTABSPACE",
	CLIENTID VARCHAR2(254) NOT NULL,
	USERID VARCHAR2(256),
...
ALTER TABLE HOMEPAGE.OAUTH2_CLIENT
  ...
  REFERENCES HOMEPAGE.OAUTH2_PROVIDER(NAME) ON DELETE CASCADE INITIALLY DEFERRED DEFERRABLE;
...
CREATE TABLE HOMEPAGE.OAUTH2_GADGET_BINDING (
  ...
  CONSTRAINT PK_GADGET_PK UNIQUE (URI_SHA1, SERVICE_NAME) USING INDEX  TABLESPACE "NEWSINDEXTABSPACE" -- Needed to overcome mssql index size limits
)
TABLESPACE "HOMEPAGEREGTABSPACE";
