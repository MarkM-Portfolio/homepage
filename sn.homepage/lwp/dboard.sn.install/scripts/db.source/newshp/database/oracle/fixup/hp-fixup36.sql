...
CREATE INDEX HOMEPAGE.NT_NOTIFICATION_FP_INDEX
	ON HOMEPAGE.NT_NOTIFICATION(FIRST_RECIPIENT_EXID) TABLESPACE "HPNTINDEXTABSPACE";
...
CREATE INDEX HOMEPAGE.NT_NOTIFICATION_EXID_INDEX
	ON "HOMEPAGE"."NT_NOTIFICATION"("SENDER_ID") TABLESPACE "HPNTINDEXTABSPACE";

------------------ NT_NOTIFICATION_RECIPIENT --------------
ALTER TABLE HOMEPAGE.NT_NOTIFICATION_RECIPIENT
ADD RECIPIENT_ID VARCHAR2(36);
...
CREATE INDEX HOMEPAGE.NT_NOT_RECIPIENT_INDEX
	ON HOMEPAGE.NT_NOTIFICATION_RECIPIENT(RECIPIENT_ID) TABLESPACE "HPNTINDEXTABSPACE";
