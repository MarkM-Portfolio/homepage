...
CREATE INDEX HOMEPAGE.NT_NOTIFICATION_IDX
    ON HOMEPAGE.NT_NOTIFICATION (DATETIME_STAMP DESC, FIRST_RECIPIENT_ID, SENDER_ID) TABLESPACE "HPNTINDEXTABSPACE";

CREATE INDEX HOMEPAGE.NT_FIRST_RECIPIENT_PER
    ON HOMEPAGE.NT_NOTIFICATION (FIRST_RECIPIENT_ID) TABLESPACE "HPNTINDEXTABSPACE";