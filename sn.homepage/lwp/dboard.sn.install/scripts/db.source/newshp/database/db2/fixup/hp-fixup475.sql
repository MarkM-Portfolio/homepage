...
SELECT CURRENT_TIMESTAMP, 'CURRENT_TIMESTAMP: [START] fixup475 - start EXPORT\IMPORT data.tmp.ixf' FROM SYSIBM.SYSDUMMY1@
...
SELECT CURRENT_TIMESTAMP, 'CURRENT_TIMESTAMP: [END] fixup475 - end EXPORT\IMPORT data.tmp.ixf' FROM SYSIBM.SYSDUMMY1@
