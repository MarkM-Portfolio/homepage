...
--------------------------------------------------------------------------------------------
ALTER TABLE HOMEPAGE.NR_AGGREGATED_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_RESPONSES_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_PROFILES_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_COMMUNITIES_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_ACTIVITIES_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_BLOGS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_BOOKMARKS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_FILES_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_FORUMS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_WIKIS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_TAGS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_STATUS_UPDATE_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_EXTERNAL_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_ACTIONABLE_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_NOTIFICATION_SENT_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_NOTIFICATION_RECEIV_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_SAVED_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_TOPICS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_MENTIONS_READERS ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_DISCOVERY_VIEW ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@

ALTER TABLE HOMEPAGE.NR_PROFILES_VIEW ADD COLUMN COMMUNITY_ID VARCHAR(36)@
COMMIT@
