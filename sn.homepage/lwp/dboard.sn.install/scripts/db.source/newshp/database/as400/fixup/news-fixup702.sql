...
-----------------------------------------------------------------------
ALTER TABLE HOMEPAGE.HOMEPAGE_SCHEMA ADD COLUMN PRESCHEMAVER VARCHAR(10) CCSID 1208 DEFAULT '0' NOT NULL;
ALTER TABLE HOMEPAGE.HOMEPAGE_SCHEMA ADD COLUMN POSTSCHEMAVER VARCHAR(10) CCSID 1208 DEFAULT '0' NOT NULL;
