...
ALTER TABLE HOMEPAGE.TMP
    ADD CONSTRAINT HOMEPAGE.PK_TMP PRIMARY KEY (CATEGORY_READER_ID);
COMMIT;
...
COMMIT;
*/
UPDATE HOMEPAGE.BOARD_RECOMMENDATIONS SET RECOMMENDER_ID_DISPLAY = RECOMMENDER_ID, CREATION_DATE_DISPLAY = CREATION_DATE WHERE RECOMMENDER_ID_DISPLAY IS NULL ;
COMMIT;
...
ALTER TABLE HOMEPAGE.NR_AGGREGATED_READERS DROP CONSTRAINT HOMEPAGE.PK_AGG_READERS;
COMMIT;

ALTER TABLE HOMEPAGE.NR_AGGREGATED_READERS DROP CONSTRAINT HOMEPAGE.FK_AGG_READERS_STR;
COMMIT;
	
ALTER TABLE HOMEPAGE.NR_AGGREGATED_READERS DROP CONSTRAINT HOMEPAGE.FK_AGG_READERS_ORG_ID;
COMMIT;
