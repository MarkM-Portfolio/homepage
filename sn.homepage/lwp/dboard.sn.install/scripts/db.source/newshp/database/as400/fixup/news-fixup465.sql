...
-- 110166: fixup465 - rename BOARD_OBJECT_REFERENCE.MIME_TYPE to BOARD_OBJECT_REFERENCE.TYPE
...
-- Copy data
INSERT INTO HOMEPAGE.BOARD_OBJECT_REFERENCE_TEMP(OBJECT_ID, ITEM_ID, DISPLAY_NAME, IMAGE_NAME, NAME, URL, CONTENT, IMAGE_URL, SOURCE, SOURCE_TYPE, CREATION_DATE, TYPE, AUTHOR_ID, AUTHOR_DISPLAY_NAME, OBJECT_META_DATA, OBJECT_META_DATA_2, FULL_OBJECT_META_DATA, OBJECT_EXTERNAL_ID, ORGANIZATION_ID) 
...
-- Drop constraints
--ALTER TABLE BOARD_OBJECT_REFERENCE DROP FOREIGN KEY "HOMEPAGE".FK_BRD_OBJ_ENTRY;

ALTER TABLE BOARD_OBJECT_REFERENCE DROP FOREIGN KEY "HOMEPAGE".FK_BRD_AUTHOR_ID;

ALTER TABLE BOARD_OBJECT_REFERENCE DROP FOREIGN KEY "HOMEPAGE".FK_BRD_OBJ_REFERENCE_ORG_ID;
