...
CREATE TABLE HOMEPAGE.SR_RECOMMEND_CACHE_USERPROFILE (
	RECOMMEND_CACHE_USERPROFILE_ID nvarchar(36) NOT NULL,	
	PERSON_ID nvarchar(36) NOT NULL,
	CACHED_VALUE_IN_JSON nvarchar(3000) DEFAULT 'none' NOT NULL,
...
CREATE UNIQUE INDEX SR_UNIQUE_RCUP_PERSON_ID  
	ON HOMEPAGE.SR_RECOMMEND_CACHE_USERPROFILE (PERSON_ID); 
GO
	
CREATE UNIQUE INDEX SR_UNIQUE_RCUP_PERSON_ID_UDATE  
