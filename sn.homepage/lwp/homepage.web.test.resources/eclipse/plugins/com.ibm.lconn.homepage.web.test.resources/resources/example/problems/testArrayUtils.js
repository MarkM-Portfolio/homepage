...
dojo.provide("lconn.homepage.tests.example.problems.testArrayUtils");

dojo.require("com.ibm.social.test.testUtil");
dojo.require("lconn.homepage.tests.example.problems.arrayUtils");
...
com.ibm.social.test.testUtil.registerGroup("example.problems.testArrayUtils",
	...
	null,
	{
		util: lconn.homepage.tests.example.problems.arrayUtils,
		setUp: function(){
