...
dojo.provide("lconn.homepage.tests.example.problems.testStringUtils");

dojo.require("com.ibm.social.test.testUtil");
dojo.require("lconn.homepage.tests.example.problems.stringUtils");
...
com.ibm.social.test.testUtil.registerGroup("example.problems.testStringUtils",
	...
	null,
	{
		testAdd: dojo.hitch(lconn.homepage.tests.example.problems.stringUtils, lconn.homepage.tests.example.problems.stringUtils.add)
	}
);