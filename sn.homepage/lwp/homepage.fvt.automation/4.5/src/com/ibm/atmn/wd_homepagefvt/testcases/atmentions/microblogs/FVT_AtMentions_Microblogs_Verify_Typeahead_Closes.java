...
public class FVT_AtMentions_Microblogs_Verify_Typeahead_Closes extends
	...
	public void test_At_Mentions_33_CheckTypeAheadCloses() throws Exception {
		...
		System.out
				.println("INFO: Start of test_At_Mentions_33_CheckTypeAheadCloses");
		...
		assertTrue("Fail - Typeahead did not close", !driver
				.isTextPresent("Person not listed? Use full search..."));
		...
		System.out
				.println("INFO: End of test_At_Mentions_33_CheckTypeAheadCloses");
