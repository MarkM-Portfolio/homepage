...
public class FVT_ImFollowing_Public_Comm_Forums extends FVT_ForumsMethods {
...
public void testForumCreated_PublicComm() throws Exception {
		...
		//(CommonData.IC_LDAP_Username450, CommonData.IC_LDAP_Password450);
		Login(testUser1);
...
public void testFollowPublicCommunity() throws Exception {
		...
		assertTrue("Text not present!",driver.isTextPresent(" created the "+PublicCommForum+" forum."));
...
public void testForumUpdated_PublicComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, PublicCommForum, null, testUser1.getDisplayName());
...
public void testForumTopicCreated_PublicComm() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
...
public void testForumTopicReply_PublicComm() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
...
public void testForumTopicUpdated_PublicComm() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
...
public void testForumTopicReplyUpdated_PublicComm() throws Exception {
		...
		//Update to the topic
		updateReply2(PublicCommForum);
		
		//Logout
		LogoutAndClose();
		
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_REPLY_THREAD, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
