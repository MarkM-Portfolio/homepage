...
public class FVT_Discover_Public_Comm_Blogs extends FVT_BlogsMethods{
	...
	public void testCreateBlogEntry_PublicComm() throws Exception {
		...
		smartSleep(FVT_CommunitiesObjects.LeftNavBlogs);
		//Go to blogs
		driver.getFirstElement(FVT_CommunitiesObjects.LeftNavBlogs).click();
		
		if(!driver.isElementPresent(FVT_BlogsObjects.BlogsNewEntry)){
			driver.getFirstElement(FVT_CommunitiesObjects.LeftNavBlogs).click();
		}
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		//Recommend entry
		driver.getFirstElement(FVT_BlogsObjects.BlogsCommentRecommend).click();
