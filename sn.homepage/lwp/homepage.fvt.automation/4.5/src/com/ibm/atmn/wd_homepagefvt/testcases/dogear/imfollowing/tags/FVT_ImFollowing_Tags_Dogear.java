...
public class FVT_ImFollowing_Tags_Dogear extends FVT_DogearMethods {
	...
	public void testPrivateBookmarkAdded() throws Exception {
		...
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.CREATE_BOOKMARK, PRIVATE_BOOKMARK_NAME, null, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingTagsNewsStory, FVT_NewsData.BOOKMARKS, CommonData.AutomationTag, false, false);
	...
	public void testPrivateBookmarkEdited() throws Exception {
		...
		// Verify story appears in AS -> Discover
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BOOKMARK, PRIVATE_BOOKMARK_NAME, null, testUser1.getDisplayName());
	...
	public void testPublicBookmarkAdded() throws Exception {
		...
		// Verify story appears in AS -> Discover
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.CREATE_BOOKMARK, PUBLIC_BOOKMARK_NAME, null, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingTagsNewsStory, FVT_NewsData.BOOKMARKS, CommonData.AutomationTag, false, true);
	...
	public void testPublicBookmarkEdited() throws Exception {
		...
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BOOKMARK, PUBLIC_BOOKMARK_NAME, null, testUser1.getDisplayName());
	...
	public void testAddTagToWatchlist() throws Exception {
		...
		// Verify story appears in AS -> Discover
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.ADD_TAG, NewsStoryData.TAG_NAME, null, testUser1.getDisplayName());
