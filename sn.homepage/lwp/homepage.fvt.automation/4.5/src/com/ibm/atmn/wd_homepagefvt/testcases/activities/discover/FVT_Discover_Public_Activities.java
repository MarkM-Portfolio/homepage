...
public class FVT_Discover_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity() throws Exception {
			...
			String ActivityNewsStory = replaceNewsStory(NewsStoryData.MAKE_ACTIVTY_PUBLIC, publicActivityName, null, testUser1.getDisplayName());
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		//verifyNewsStory_TwoFilters(testUser2," Description for automated FVT level2","Discover","All","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateEntry() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY_ENTRY, publicActivityPrivateEntryTitle, publicActivityName, testUser1.getDisplayName());
	...
	public void testCreateStandPublicActivity_PrivateToDo() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_TODO_ITEM, publicActivityPrivateToDoName, publicActivityName, testUser1.getDisplayName());
		verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, false);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		//verifyNewsStory_TwoFilters(testUser2,"created a to-do item named "+publicAssignedToDoName+" in the "+publicActivityName+" activity.","Discover","All","Activities", true);
	...
	public void testMiscellaneousCreateSection() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_SECTION, publicActivityName, null, testUser1.getDisplayName());
		//verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, true);
		//create section currently not showing up in news feed
	...
	public void testMiscellaneousParentActivityRename() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.COMPLETE_A_TODO_ITEM, publicAssignedToDoName, "Edited FVT Automation Activity", testUser1.getDisplayName());
		verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, true);
		
		
		//Verify that news story appears in  Activity Steam -> Discover
		//verifyNewsStory_TwoFilters(testUser2,"completed the "+publicAssignedToDoName+" to-do item in the Edited FVT Automation Activity activity.","Discover","All","Activities", true);
