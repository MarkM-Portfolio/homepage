...
public class FVT_ImFollowing_People_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_ModeratedComm () throws Exception {
			...
			ModeratedWikiCommunity = CreateNewCommunity(FVT_CommunitiesData.ModeratedCommunityName+DateTimeStamp, FVT_CommunitiesData.CommunityHandle+DateTimeStamp, FVT_CommunitiesObjects.CommunityAccessOption2, "Members", FVT_CommunitiesObjects.CommunityMembersTypeAhead, testUser3.getEmail());
			...
			//verifyNewsStory_ThreeFilters(testUser2," created a wiki "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, true);
			//verifyNewsStory_ThreeFilters(testUser2," created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, true);
			//verifyNewsStory_ThreeFilters(testUser2," edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, false);
			//verifyNewsStory_ThreeFilters(testUser2," tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, true);
			//verifyNewsStory_ThreeFilters(testUser2," liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, true);
			//verifyNewsStory_ThreeFilters(testUser2," commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditCommentWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.UPDATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory_TwoFilters(testUser2, WikiNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.COMMUNITIES, FVT_NewsData.PEOPLE, true);
			//verifyNewsStory_ThreeFilters(testUser2,"updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
