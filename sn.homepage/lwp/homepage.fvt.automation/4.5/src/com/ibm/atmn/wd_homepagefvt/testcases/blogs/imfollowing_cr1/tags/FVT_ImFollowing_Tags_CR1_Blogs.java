...
public class FVT_ImFollowing_Tags_CR1_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testAddCommentStandaloneEntry() throws Exception{
		...
		verifyImFollowingTagsNewsStory(testUser2, "commented on their own "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.","Blogs","automation",false, false);
	...
	public void testRecommendStandaloneEntry() throws Exception{
		...
		verifyImFollowingTagsNewsStory(testUser2, "liked their own "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.","Blogs", "automation", false, false);
	...
	public void testRecommendCommentStandaloneEntry() throws Exception{
		...
		verifyImFollowingTagsNewsStory(testUser2, "liked their own comment on "+StandaloneBlogEntry+".","Discover", "automation", false, false);
