...
public class FVT_Microblogs_LinkToProfile extends FVT_AtMentionsMethods {
	...
	public void test_AtMentions_LinkToProfile_009 () throws Exception {
		...
		clickLink("css=div.lotusPostContent span.vcard a.fn:contains(@"+testUser2.getDisplayName()+")");
