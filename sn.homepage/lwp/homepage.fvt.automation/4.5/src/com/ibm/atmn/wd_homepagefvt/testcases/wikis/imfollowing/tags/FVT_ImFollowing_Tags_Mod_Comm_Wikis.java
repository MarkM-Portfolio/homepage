...
public class FVT_ImFollowing_Tags_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_ModeratedComm () throws Exception {
			...
			ModeratedWikiCommunity = CreateNewCommunity(FVT_CommunitiesData.ModeratedCommunityName+DateTimeStamp, FVT_CommunitiesData.CommunityHandle+DateTimeStamp, FVT_CommunitiesObjects.CommunityAccessOption2, "Members", FVT_CommunitiesObjects.CommunityMembersTypeAhead, testUser2.getEmail());
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY, ModeratedWikiCommunity, null, testUser1.getDisplayName());
			
			//story not showing up under communities - referred
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, CommonData.AutomationTag, false, true);
		    //verifyImFollowingTagsNewsStory(testUser2, "A "+ModeratedWikiCommunity+" community wiki was created.","Wikis","automation", true, true);
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
//			verifyImFollowingTagsNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", "automation",true, true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
			//verifyImFollowingTagsNewsStory(testUser2, " edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis",  "automation",true, true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, FVT_WikisData.Tag_For_Public_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", "automation",true, false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
		
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", "automation",true, true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " commented on the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", "automation",true, true);
		...
		public void testEditCommentWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
			//verifyImFollowingTagsNewsStory(testUser2, " updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis","automation",true, true);
