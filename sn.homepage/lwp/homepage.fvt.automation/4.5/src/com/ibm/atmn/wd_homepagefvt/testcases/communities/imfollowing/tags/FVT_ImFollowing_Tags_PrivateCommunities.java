...
public class FVT_ImFollowing_Tags_PrivateCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreatePrivateComm() throws Exception {
			...
			String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY, PrivateCommunity, null, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingTagsNewsStory, FVT_NewsData.COMMUNITIES, CommonData.AutomationTag, false, false);
	...
	public void testCreateFeed_PrivateComm() throws Exception {
		...
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.ADD_COMMUNITY_FEED, PrivateCommFeed, PrivateCommunity, testUser1.getDisplayName());
	...
	public void testAddBookmark_PrivateComm() throws Exception {
		...
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.ADD_COMMUNITY_FEED, PrivateCommBookmark, PrivateCommunity, testUser1.getDisplayName());
	...
	public void testUpdateBookmark_PrivateComm() throws Exception {
		...
		String ImFollowingTagsNewsStory = replaceNewsStory(NewsStoryData.UPDATE_COMMUNITY_BOOKMARK, PrivateCommBookmark, PrivateCommunity, testUser1.getDisplayName());
