...
public class FVT_ImFollowing_Mod_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testFollowModCommunity() throws Exception {
			...
			System.out.println("INFO: Start of Forums FVT_Level_2 testFollowModCommunity");
			...
			assertTrue("Text not present!",driver.isTextPresent(" created the "+ModeratedCommForum+" forum."));
			...
			System.out.println("INFO: End of Forums FVT_Level_2 testFollowModCommunity");
	...
	public void testForumUpdated_ModComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, ModeratedCommForum, null, testUser1.getDisplayName());
		
		//verifyImFollowingNewsStory(testUser2,ForumNewsStory,FVT_NewsData.COMMUNITIES, true);
		verifyNewsStory(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.COMMUNITIES, true);
		sleep(500);
		verifyNewsStory_TwoFilters(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, FVT_NewsData.FORUMS, false);
		//verifyImFollowingNewsStory(testUser2," updated the "+ModeratedCommForum+" forum.","Forums", true);
	...
	public void testForumTopicCreated_ModComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
		
		verifyImFollowingNewsStory(testUser2,ForumNewsStory,FVT_NewsData.FORUMS, true);
		//verifyImFollowingNewsStory(testUser2," created a topic named "+ModeratedCommTopic+" in the "+ModeratedCommForum+" forum.","Forums", true);	
	...
	public void testForumTopicReply_ModComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
		
		verifyImFollowingNewsStory(testUser2,ForumNewsStory,FVT_NewsData.FORUMS, true);
		//verifyImFollowingNewsStory(testUser2,"replied to the Re: "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","Forums", true);
	...
	public void testForumTopicUpdated_ModComm() throws Exception {
		...
		//verifyImFollowingNewsStory(testUser2," updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.","Communities", true);
		verifyNewsStory(testUser2, " updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.",FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.COMMUNITIES, true);
		//verifyNewsStory(testUser2, " updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.",FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.FORUMS, false);
		sleep(500);
		verifyNewsStory_TwoFilters(testUser2,  " updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.",FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, FVT_NewsData.FORUMS, false);
	...
	public void testForumTopicReplyUpdated_ModComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_REPLY_THREAD, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
		
		//verifyImFollowingNewsStory(testUser2," updated the "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","Forums", true);
		verifyNewsStory(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.COMMUNITIES, true);
		sleep(500);
		verifyNewsStory_TwoFilters(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, FVT_NewsData.FORUMS, false);
		//verifyNewsStory(testUser2, " updated the "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.",FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.FORUMS, false);
		//verifyImFollowingNewsStory(testUser2,ForumNewsStory,"Forums", true);
