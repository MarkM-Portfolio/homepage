...
public class FVT_Discover_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_COMMUNITY, ModeratedWikiCommunity, null, testUser1.getDisplayName());
			
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, true);
			//verifyNewsStory(testUser2, "A "+ModeratedWikiCommunity+" community wiki was created.","Discover","Wikis", true);
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Child_Page_For_Mod_Comm_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
						
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, true);
			//verifyNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, true);
			//verifyNewsStory(testUser2, " edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki, FVT_WikisData.Tag_For_Public_Wiki, ModeratedWikiCommunity, testUser1.getDisplayName());
			
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, false);
			//verifyNewsStory(testUser2, " tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, true);
			//verifyNewsStory(testUser2, " liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory(testUser2,WikiNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.WIKIS, true);
			//verifyNewsStory(testUser2, " commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
