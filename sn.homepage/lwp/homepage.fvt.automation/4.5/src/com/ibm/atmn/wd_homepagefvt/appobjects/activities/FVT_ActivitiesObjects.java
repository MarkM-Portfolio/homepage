...
public class FVT_ActivitiesObjects extends CommonObjects {
	...
	public static String Edit_Activity_Dialogue_SaveButton = "css=input[value='Save']:nth(3)";
	...
	// Start an Entry/ToDo
	public static String New_Entry2 = "css=span.lotusBtn a:contains('Add Entry')";
	...
	public static String SaveBtn = "css=[value='Save']";
	public static String StopFollowingCheckBox = "css=[class='title']:contains('Stop Following')";
	...
	//ToDo
	public static String AddToDo = "css=span.lotusBtn a:contains('Add To Do Item'):nth(0)";
	...
	public static String SaveComment = "css=[value='Save'][class='lotusFormButton']:nth(0)";
