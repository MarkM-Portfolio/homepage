...
public class FVT_ImFollowing_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testFollowPublicActivity() throws Exception {
			...
			String activityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY, publicActivityName, null, testUser1.getDisplayName());
			
			verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, false);			
			//verifyNewsStory(testUser2," created a public activity named "+publicActivityName+".","I'm Following","Activities", false);
			
			System.out.println("INFO: End of Activities FVT_Level_2 testFollowPublicActivity");
			
		}
		
	@Test (dependsOnMethods = { "testFollowPublicActivity" })
	public void testCreateStandPublicActivity_PublicEntry() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY_ENTRY, publicActivityPublicEntryTitle, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2," created the "+publicActivityPublicEntryTitle+" entry in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.COMMENT_ON_ACTIVITY, publicActivityPublicEntryTitle, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2,"commented on the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_EditComment() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.UPDATE_ACTIVITY_ENTRY, publicActivityPublicEntryTitle, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, true);
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2," updated the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateEntry() throws Exception {
		...
		// Create a new entry within this activity
		addEntryToActivity_Basic(publicActivityName+" Entry",typist, true);
		publicActivityPrivateEntryTitle = publicActivityName+" Entry";
		...
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory(testUser2," created the "+publicActivityPrivateEntryTitle+" entry in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_PrivateComment() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.COMMENT_ON_ACTIVITY, publicEntryTitle, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory(testUser2,"commented on the "+publicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_ToDo() throws Exception {
		...
		// Create a new to do
		addToDoToActivity(publicActivityName+" To-Do", typist, false, false, testUser1);
		publicToDoName = publicActivityName+" To-Do";
			
		//Logout
		LogoutAndClose();
		
		String activityNewsStory = replaceNewsStory(NewsStoryData.CREATE_TODO_ITEM, publicToDoName, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2," created a to-do item named "+publicToDoName+" in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testMarkToDoAsCompleted_PublicActivity() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.COMPLETE_TODO_ITEM, publicToDoName, publicActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2,"completed their own "+publicToDoName+" to-do item in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateToDo() throws Exception {
		...
		// Create a new to do
		addToDoToActivity(publicActivityName+" Private To-Do", typist, true, false, testUser1);
		publicActivityPrivateToDoName = publicActivityName+" Private To-Do";
			
		//Logout
		LogoutAndClose();
		
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(testUser2," created a to-do item named "+publicActivityPrivateToDoName+" in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		// Create a new to do
		addToDoToActivity(publicActivityName+" Assigned To-Do", typist, false, true, testUser1);
		publicAssignedToDoName = publicActivityName+" Assigned To-Do";
			
		//Logout
		LogoutAndClose();
		
		String activityNewsStory = replaceNewsStory(NewsStoryData.ASSIGNED_TODO_ITEM, publicAssignedToDoName, publicActivityName, testUser1.getDisplayName());
