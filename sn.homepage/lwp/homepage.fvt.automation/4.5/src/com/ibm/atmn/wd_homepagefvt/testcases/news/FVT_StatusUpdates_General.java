...
public class FVT_StatusUpdates_General extends FVT_CommunitiesMethods{
	...
	public void testStatusUpdateAll() throws Exception {
		...
		CommentOnStatusNoFrame(StatusUpdate);
	...
	public void testRemoveComment() throws Exception {
		...
		//builder.moveToElement((WebElement) driver.getFirstElement(StatusUpdatePost).getBackingObject()).moveToElement((WebElement)driver.getFirstElement(FVT_NewsObjects.DeleteComment).getBackingObject()).click().build().perform();
	...
	public void testRemoveStatus() throws Exception {
		...
		builder.moveToElement((WebElement) driver.getFirstElement(StatusUpdatePost).getBackingObject()).moveToElement((WebElement) driver.getFirstElement(FVT_NewsObjects.DeleteStatus).getBackingObject()).click().build().perform();
