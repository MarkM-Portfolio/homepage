...
public class FVT_Discover_Dogear extends FVT_DogearMethods {
	...
	private static String BOOKMARK_TAG =  "fvttesttag";
	...
	public void testPrivateBookmarkAdded() throws Exception {
		...
		String DogearNewsStory = replaceNewsStory(NewsStoryData.CREATE_BOOKMARK, PRIVATE_BOOKMARK_NAME, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, false);
	...
	public void testPrivateBookmarkEdited() throws Exception {
		...
		System.out.println("INFO: Start of Dogear FVT Level 2 testPrivateBookmarkEdited Test");
		...
		String DogearNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BOOKMARK, PRIVATE_BOOKMARK_NAME, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, false);
		
		// Verify story appears in AS -> Discover
		//verifyNewsStory(testUser2, " updated the bookmark named "+PRIVATE_BOOKMARK_NAME+".","Discover","Bookmarks", false);

		System.out.println("INFO: End of Dogear FVT Level 2 testPrivateBookmarkEdited Test");
	...
	public void testPublicBookmarkAdded() throws Exception {
		...
		String DogearNewsStory = replaceNewsStory(NewsStoryData.CREATE_BOOKMARK, PUBLIC_BOOKMARK_NAME, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, true);
	...
	public void testPublicBookmarkEdited() throws Exception {
		...
		String DogearNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BOOKMARK, PUBLIC_BOOKMARK_NAME, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, true);
	...
	public void testAddPersonToWatchlist() throws Exception {
		...
		String DogearNewsStory = replaceNewsStory(NewsStoryData.ADD_BOOKMARK_WATCHLIST, null, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, false);
	...
	public void testAddTagToWatchlist() throws Exception {
		...
		toggleAddTagToWatchlist(BOOKMARK_TAG);
		
		// Logout of Connections
		LogoutAndClose();
		
		String DogearNewsStory = replaceNewsStory(NewsStoryData.ADD_TAG, BOOKMARK_TAG, null, testUser1.getDisplayName());
		verifyNewsStory(testUser2, DogearNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BOOKMARKS, false);
