...
public class FVT_AtMentions_ModComm extends FVT_AtMentionsMethods{
	...
	@Test
	public void Status_Update_ModComm_23 () throws Exception {
		...
		//Verify NewsStory
		String atMentionsNewsStory = replaceNewsStory(NewsStoryData.MENTIONED_YOU_COMMUNITY, ModeratedCommunity, null, testUser1.getDisplayName());
		
		verifyNewsStory(atMentionsNewsStory, "@Mentions", null, testUser2, true);
	  	
		System.out.println("INFO: End of test_@Mention23 MESSAGE DIRECTED IN A MODERATED COMMUNITY STATUS UPDATE");
	}
	
	@Test (dependsOnMethods = { "Status_Update_ModComm_23" })
	public void Status_Update_Comment_ModComm_33() throws Exception{
		...
		//Verify NewsStory
		String atMentionsNewsStory = replaceNewsStory(NewsStoryData.MENTIONED_YOU_COMMENT_COMM, ModeratedCommunity, null, testUser1.getDisplayName());
