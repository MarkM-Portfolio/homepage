...
public class FVT_ImFollowing_Tags_CR1_Mod_Comm_Ideablog extends FVT_BlogsMethods{
	/*
	...
	public void testCreateModComm() throws Exception {
		...
		Reporter.log("ModeratedIdeablogCommunity   ==   "+ModeratedIdeablogCommunity);
		
		//Logout
		LogoutAndClose();
				
		//Logging in as User2 and following the new community 
		LoadComponent(CommonObjects.ComponentCommunities);
		
		Login(testUser2);
		driver.getFirstElement("css=a[title='View communities where you are a member']").click();
		clickLink("link="+ModeratedIdeablogCommunity);
		clickLink(CommunitiesObjects.FollowACommunity);		
	...
	public void testCreateIdeablog_ModComm() throws Exception {
		...
		//Delay before newsstory appears in feed
	...
	public void testAddCommentToIdea_ModComm() throws Exception {
		...
		//newsstory showing up in feed and should not be 
		//verifyImFollowingTagsNewsStory(testUser2, "commented on their own "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, false);
	...
	public void testIdeaVoted_ModComm() throws Exception {
		...
		String blogsNewsStory = replaceNewsStory(NewsStoryData.VOTE_FOR_OWN_IDEA, ModeratedIdeablogEntry, ModeratedIdeablogCommunity, testUser1.getDisplayName());
		
		//not showing up under tags - appears undere blogs/communities
		//verifyImFollowingTagsNewsStory(testUser2, blogsNewsStory, "Blogs", CommonData.AutomationTag, true, true);
		
		System.out.println("INFO: End of Blogs FVT_Level_2 testIdeaVoted_ModComm");
		
	}
	
	@Test (dependsOnMethods = { "testIdeaVoted_ModComm" },groups = {"notbvt3", "brokenIE"})
	public void testRecommendComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "liked their own comment on "+ModeratedIdeablogEntry+".","Tags","automation",false, false);
	...
	public void testIdeaGraduated_ModComm() throws Exception {
		...
		//NewsStory Issues - commented out pending fix
