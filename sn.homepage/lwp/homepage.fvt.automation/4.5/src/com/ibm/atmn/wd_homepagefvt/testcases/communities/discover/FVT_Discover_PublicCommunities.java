...
public class FVT_Discover_PublicCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreatePublicComm() throws Exception {
		...
		String CommunityNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY, PublicCommunity, null, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,CommunityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.COMMUNITIES, true);
