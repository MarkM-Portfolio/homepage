...
public class FVT_ImFollowing_Tags_PublicCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateFeed_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " added the "+PublicCommFeed+" feed to the "+PublicCommunity+" community.","Communities","automation", false, true);
	...
	public void testAddBookmark_PublicComm() throws Exception {
		...
		System.out.print(" added the "+PublicCommBookmark+" bookmark to the "+PublicCommunity+" community.");
		
		verifyImFollowingTagsNewsStory(testUser2, " added the "+PublicCommBookmark+" bookmark to the "+PublicCommunity+" community.","Communities","automation", false, true);
	...
	public void testUpdateBookmark_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " updated the "+PublicCommBookmark+" bookmark in the "+PublicCommunity+" community.","Communities","automation", false, true);
