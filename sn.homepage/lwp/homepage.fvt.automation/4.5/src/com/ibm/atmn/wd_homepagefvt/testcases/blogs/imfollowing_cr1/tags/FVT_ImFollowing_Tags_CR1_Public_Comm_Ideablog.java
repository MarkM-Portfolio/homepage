...
public class FVT_ImFollowing_Tags_CR1_Public_Comm_Ideablog extends FVT_BlogsMethods{
	/*
	...
	public void testCreateIdeablog_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " added an Ideation Blog to the "+PublicIdeablogCommunity+" community.","Blogs","automation",true, true);
	...
	public void testCreateIdea_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " created the "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testUpdateIdea_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " updated the "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testAddCommentToIdea_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"commented on their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, false);
	...
	public void testCreateATrackbackToIdea_PublicComm() throws Exception {
		...
		//verifyImFollowingTagsNewsStory(testUser2,"left a trackback on their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, false);
	...
	public void testIdeaVoted_PublicComm() throws Exception {
		...
		//verifyImFollowingTagsNewsStory(testUser2," voted for the "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"liked their own comment on "+PublicIdeablogEntry+".","Tags","automation",true, false);
	...
	public void testIdeaGraduated_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "graduated their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
