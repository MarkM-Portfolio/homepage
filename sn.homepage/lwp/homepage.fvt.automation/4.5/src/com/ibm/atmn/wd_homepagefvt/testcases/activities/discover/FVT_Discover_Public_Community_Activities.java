...
public class FVT_Discover_Public_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PublicComm() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY, PublicCommunityActivity, null, testUser1.getDisplayName());
	...
	public void testMarkToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory_TwoFilters(testUser2,"completed the "+PublicActivityToDo+" to-do item in the "+PublicCommunityActivity+" activity.","Discover","All","Activities", true);
