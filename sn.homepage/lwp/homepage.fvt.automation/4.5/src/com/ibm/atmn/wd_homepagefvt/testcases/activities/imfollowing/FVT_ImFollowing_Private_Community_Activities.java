...
public class FVT_ImFollowing_Private_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PrivateComm() throws Exception {
		...
		//set to true as the user follows the community earlier
	...
	public void testCreateActivityEntry_PrivateComm() throws Exception {
		...
		addEntryToActivity_Basic(PrivateCommunityActivity +" Entry",typist, false);
		PrivateActivityEntry = PrivateCommunityActivity +" Entry";
	...
	public void testEditActivityComment_PrivateComm() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.UPDATE_ACTIVITY_ENTRY, PrivateActivityEntry, PrivateCommunityActivity, testUser1.getDisplayName());
