...
public class FVT_DogearObjects extends CommonObjects {
	...
	//public static String NotifyDropDownPerson1 = "css=*[id='notifyEmails_popup'] li";
	public static String NotifyDropDownPerson1 = "css=li[persontype='0'][aria-describedby='bc_document_node']";
	...
	public static String EditButton = "css=a[id^=link_1]";
