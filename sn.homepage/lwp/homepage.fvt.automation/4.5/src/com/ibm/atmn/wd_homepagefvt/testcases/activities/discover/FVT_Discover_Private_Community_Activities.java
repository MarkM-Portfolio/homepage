...
public class FVT_Discover_Private_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PrivateComm() throws Exception {
		...
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY, PrivateCommunityActivity, null, testUser1.getDisplayName());
		...
		//verifyNewsStory_TwoFilters(testUser2," created an activity named "+PrivateCommunityActivity+".","Discover","All","Activities", false);
	...
	public void testCreateActivityEntry_PrivateComm() throws Exception {
		...
		LogoutAndClose();
		//Replace news story string
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY_ENTRY, PrivateActivityEntry, PrivateCommunityActivity, testUser1.getDisplayName());
		
		verifyNewsStory_TwoFilters(testUser2,ActivityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory_TwoFilters(testUser2," created the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Discover","All","Activities", false);
	...
	public void testCreateActivityComment_PrivateComm() throws Exception {
		...
		LogoutAndClose();
		//Replace news story string
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.COMMENT_ON_ACTIVITY, PrivateActivityEntry, PrivateCommunityActivity, testUser1.getDisplayName());
		
		verifyNewsStory_TwoFilters(testUser2,ActivityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory_TwoFilters(testUser2,"commented on their own "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Discover","All","Activities", false);
	...
	public void testCreateActivityToDo_PrivateComm() throws Exception {
		...
		LogoutAndClose();
		//Replace news story string
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.CREATE_TODO_ITEM, PrivateActivityToDo, PrivateCommunityActivity, testUser1.getDisplayName());
		
		verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory_TwoFilters(testUser2," created a to-do item named "+PrivateActivityToDo+" in the "+PrivateCommunityActivity+" activity.","Discover","All","Activities", false);
	...
	public void testMarkToDoAsCompleted_PrivateComm() throws Exception {
		...
		LogoutAndClose();
		//Replace news story string
		String ActivityNewsStory = replaceNewsStory(NewsStoryData.COMPLETE_TODO_ITEM, PrivateActivityToDo, PrivateCommunityActivity, testUser1.getDisplayName());
		
		verifyNewsStory_TwoFilters(testUser2, ActivityNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.ALL, FVT_NewsData.ACTIVITIES, false);
		//verifyNewsStory_TwoFilters(testUser2,"completed their own "+PrivateActivityToDo+" to-do item in the "+PrivateCommunityActivity+" activity.","Discover","All","Activities", false);
