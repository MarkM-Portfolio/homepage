...
public class FVT_Saved_Blogs extends FVT_BlogsMethods {
	...
	public void testMarkingBlogStoriesAsSaved() throws Exception {
		...
		driver.getFirstElement(BlogsStory).hover();
	...
	public void testMarkingBlogStoriesAsSavedPart2() throws Exception {
		...
		//assertTrue("Fail: Link still there!!", driver.getFirstElement("div.activityStreamNewsItemContainer div.lotusPostContent").isTextPresent("Saved"));
	...
	public void testMarkingBlogStoriesAsSavedPart3() throws Exception {
		...
		builder.moveToElement((WebElement) driver.getFirstElement(BlogsCommentStory).getBackingObject()).moveToElement((WebElement) driver.getFirstElement(FVT_NewsObjects.DeleteSavedStory).getBackingObject()).click().build().perform();
