...
public class CommonObjects {
	...
	*/
	...
	private static final String APP_PROPERTIES_PATH = "test_config/app/app.properties";
	private static final Properties properties = FileIOHandler.loadExternalProperties(APP_PROPERTIES_PATH);
	...
	public static final String ComponentCRE = properties.getProperty("test_component_cre");
	...
	//Logout
	public static final String UserDropdown = "css=a#headerUserName.lotusUser";
	//public static final String Logout_Link = "link=Log Out";
	//public static final String Logout_Link = "css=tr td#logoutLi.lotusNowrap a";
	public static final String Logout_Link = "css=td#logoutContainer.lotusNowrap a#logoutLink";

	//Start Button for components
	public static final String StartButton = "css=*[id='createAllBtn']";

	//Submit button and Cancel Links
	public static String SaveButton = "css=[value='Save']";
	public static String BookmarkSaveButton = "css=input#submitBtn.lotusFormButton";
	public static String SaveButton2 = "css=span input.lotusFormButton";
	...
	//public static String Banner_Apps_Forums = "css=strong:contains('Forums')";
	...
	public static String Banner_Apps_Wikis ="//tr[6]/th/a/strong";
	...
	//
	public static final String ImAnOwner = "I'm an Owner";
	public static final String ImAMember = "I'm a Member";
	
	public static String EditSaveButton = "css=input[type='submit'][value='Save'][name='submit']";
	
	public static String SEND_BUTTON = "css=input[value='Send']";
