...
public class FVT_Discover_PrivateCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreatePrivateComm() throws Exception {
			...
			String CommunityNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY, PrivateCommunity, null, testUser1.getDisplayName());
			
			verifyNewsStory(testUser2,CommunityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.COMMUNITIES, false);
			//verifyNewsStory(testUser2, " created a community named "+PrivateCommunity+".","Discover","Communities", false);
	...
	public void testAddBookmark_PrivateComm() throws Exception {
		...
		verifyNewsStory(testUser2,CommunityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.COMMUNITIES, false);
		//verifyNewsStory(testUser2, " added the "+PrivateCommBookmark+" bookmark to the "+PrivateCommunity+" community.","Discover","Communities", false);
	...
	public void testCreateFeed_PrivateComm() throws Exception {
		...
		verifyNewsStory(testUser2,CommunityNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.COMMUNITIES, false);
		//verifyNewsStory(testUser2," added the "+PrivateCommFeed+" feed to the "+PrivateCommunity+" community.","Discover","Communities", false);
