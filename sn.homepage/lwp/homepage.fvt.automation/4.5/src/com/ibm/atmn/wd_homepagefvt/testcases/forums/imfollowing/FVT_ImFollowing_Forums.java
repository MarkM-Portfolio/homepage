...
public class FVT_ImFollowing_Forums extends FVT_ForumsMethods {
	...
	public void testFollowForum() throws Exception {
			...
			String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_FORUM, part1ForumName, null, testUser1.getDisplayName());
			
			
			System.out.println(ForumNewsStory);
	...
	public void testCreateStandaloneForumTopic() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
	...
	public void teststandaloneForumReply() throws Exception {
		...
		smartSleep("link=" + part1TopicTitle);
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
	...
	public void testUpdateStandaloneForumTopic() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
	...
	public void testUpdateStandaloneForumTopicReply() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_REPLY_THREAD, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
		
		Reporter.log("ForumNewsStory :> "+ForumNewsStory);
