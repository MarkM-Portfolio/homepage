...
public class FVT_ImFollowing_Private_Activities extends FVT_ActivitiesMethods {
	...
	public void testFollowPrivateActivity() throws Exception {
			...
			String activityNewsStory = replaceNewsStory(NewsStoryData.CREATE_ACTIVITY, privateActivityName, null, testUser1.getDisplayName());
			
			verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, false);			
			//verifyNewsStory(testUser2," created a private activity named "+privateActivityName+".","I'm Following","Activities", false);
	...
	public void testCreateStandPrivateActivity_PrivateEntry() throws Exception {
		...
		addEntryToActivity_Basic(privateActivityName+" Entry",typist, false);
		privateEntryTitle = privateActivityName+" Entry";	
		//Logout
		LogoutAndClose();
		...
		//verifyNewsStory(testUser2," created the "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPrivateActivity_Comment() throws Exception {
		...
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);		
		//verifyNewsStory(testUser2,"commented on the "+privateEntryTitle+" entry thread in the "+privateActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPrivateActivity_EditComment() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.UPDATE_ACTIVITY_ENTRY, privateEntryTitle, privateActivityName, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, true);
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);		
		//verifyNewsStory(testUser2," updated the "+privateEntryTitle+" entry thread in the "+privateActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPrivateActivity_ToDo() throws Exception {
		...
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2," created a to-do item named "+privateToDoName+" in the "+privateActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testMarkToDoAsCompleted_PrivateActivity() throws Exception {
		...
		verifyNewsStory(testUser2, activityNewsStory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ACTIVITIES, true);
		//verifyNewsStory(testUser2,"completed their own "+privateToDoName+" to-do item in the "+privateActivityName+" activity.","I'm Following","Activities", true);
