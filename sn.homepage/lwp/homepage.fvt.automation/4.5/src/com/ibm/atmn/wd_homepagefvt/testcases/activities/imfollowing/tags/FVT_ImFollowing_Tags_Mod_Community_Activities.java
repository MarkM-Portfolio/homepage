...
public class FVT_ImFollowing_Tags_Mod_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivityComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2," commented on the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testEditActivityComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"updated the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testCreateActivityToDo_ModComm() throws Exception {
		...
		// Create a new to do
		ModActivityToDo = addToDoToActivityTags(ModeratedCommunityActivity +" To-Do", CommonData.AutomationTag, typist, false, false, testUser1);
