...
public class FVT_ImFollowing_Tags_Mod_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_ModComm() throws Exception {
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_FORUM, ModeratedCommForum, null, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.FORUMS, CommonData.AutomationTag, true, true);
	...
	public void testForumUpdated_ModComm() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, ModeratedCommForum, null, testUser1.getDisplayName());
	...
	public void testForumTopicCreated_ModComm() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
	...
	public void testForumTopicReply_ModComm() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.FORUMS, CommonData.AutomationTag, true, false);
		//verifyImFollowingTagsNewsStory(testUser2, "replied to the Re: "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","Forums","automation", true, false);
	...
	public void testForumTopicUpdated_ModComm() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, ModeratedCommTopic, ModeratedCommForum, testUser1.getDisplayName());
