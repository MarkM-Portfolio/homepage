...
public class FVT_Discover_Public_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testCreateIdeablog_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.CREATE_IDEATION_BLOG, PublicIdeablogCommunity, null, testUser1.getDisplayName());
	...
	public void testCreateIdea_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.CREATE_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
		verifyNewsStory(BlogsNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BLOGS, true);
	...
	public void testUpdateIdea_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.UPDATE_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
...
//		verifyNewsStory(BlogsNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BLOGS, true);		
	...
	public void testAddCommentToIdea_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.COMMENT_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
...
//		verifyNewsStory(BlogsNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BLOGS, true);
	...
	public void testCreateATrackbackToIdea_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.CREATE_TRACKBACK_IDEATION, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
...
//		verifyNewsStory(BlogsNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BLOGS, true);		
	...
	public void testIdeaVoted_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.VOTE_FOR_BLOG, PublicIdeablogEntry, PublicIdeablogCommunity, testUser2.getDisplayName());
		
		//commented out pending advice from Vincent as to whether or not it should show up in news feed.
		//verifyNewsStory(BlogsNewsStory, FVT_NewsData.DISCOVER_VIEW, FVT_NewsData.BLOGS, true);		
	...
	@Test (dependsOnMethods = { "testIdeaVoted_PublicComm" }, groups = { "brokenIE"})
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		//Open blog comment EE
		clickLink(FVT_BlogsObjects.IdeationBlogLikePopUp);
		
		//Recommend entry
		clickLink(FVT_BlogsObjects.IdeationBlogLikeComment);
		
		//Logout
		LogoutAndClose();
			
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_COMMENT, PublicIdeablogEntry, null, testUser1.getDisplayName());
	...
	public void testIdeaGraduated_PublicComm() throws Exception {
		...
		String BlogsNewsStory = replaceNewsStory(NewsStoryData.GRADUATE_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
