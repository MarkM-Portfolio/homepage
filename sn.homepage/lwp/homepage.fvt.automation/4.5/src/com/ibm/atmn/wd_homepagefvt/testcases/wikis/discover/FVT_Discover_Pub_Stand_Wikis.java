...
public class FVT_Discover_Pub_Stand_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewPublicWiki () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI, FVT_WikisData.CI_Box_Public_Wiki, null, testUser1.getDisplayName());
		...
		public void testEditPageInPublicWiki () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Public_Wiki2, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
		...
		public void testRecommendAPageForPublicWiki () throws Exception {
		    ...
		    //Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_WELCOME, FVT_WikisData.CI_Box_Public_Wiki, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
		...
		public void testAddCommentToPublicWiki () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_WELCOME, FVT_WikisData.CI_Box_Public_Wiki, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
