...
public class FVT_ImFollowing_Pub_Comm_Wikis extends FVT_WikisMethods {
	...
	public void testCreateANewWiki_PublicComm() throws Exception {
		...
		PublicWikiCommunity = CreateNewCommunity(
	...
	public void testFollowPublicCommunity() throws Exception {
		...
		assertTrue("Text not present!", driver.isTextPresent("A "
				+ PublicWikiCommunity + " community wiki was created."));
	...
	public void testCreateANewWikiPage_PublicComm() throws Exception {
		...
		openCommunity(PublicWikiCommunity, FVT_CommunitiesObjects.ImAnOwner,
				FVT_CommunitiesObjects.LeftNavWiki);

		// Select rootpage to create child pages
		AddAPeer(FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki,
				FVT_WikisData.New_Content_For_Pub_Comm_Wiki);

		// Add a new Peer pages to the wiki homepage
		AddAChild(FVT_WikisData.New_Child_Page_For_Pub_Comm_Wiki,
				FVT_WikisData.New_Content_For_Pub_Comm_Wiki);
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE,
				FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki,
				PublicWikiCommunity, testUser1.getDisplayName());

		verifyImFollowingNewsStory(testUser2, wikiNewsStory,
				FVT_NewsData.WIKIS, true);
		// verifyImFollowingNewsStory(testUser2,
		// " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// true);
	...
	public void testEditAWikiPage_PublicComm() throws Exception {
		...
		driver.getSingleElement(WikisObjects.Page_Name_Textfield_In_Editor)
				.clear();
		driver.getSingleElement(WikisObjects.Page_Name_Textfield_In_Editor)
				.type(FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki);
		...
		Assert
				.assertTrue(
						...
						driver
								.isTextPresent(FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki));

		// Logout
		LogoutAndClose();

		String wikiNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE,
				FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki,
				PublicWikiCommunity, testUser1.getDisplayName());

		verifyImFollowingNewsStory(testUser2, wikiNewsStory,
				FVT_NewsData.WIKIS, true);
		// verifyImFollowingNewsStory(testUser2,
		// " edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// true);
	...
	public void testAddATagToWiki_PublicComm() throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE,
				FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki,
				FVT_WikisData.Tag_For_Public_Wiki, PublicWikiCommunity,
				testUser1.getDisplayName());

		verifyImFollowingNewsStory(testUser2, wikiNewsStory,
				FVT_NewsData.WIKIS, false);
		// verifyImFollowingNewsStory(testUser2,
		// " tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// false);
	...
	public void testRecommendAWiki_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2, wikiNewsStory,
				FVT_NewsData.WIKIS, true);
		// verifyImFollowingNewsStory(testUser2,
		// " liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// true);
	...
	public void testAddCommentToWiki_PublicComm() throws Exception {
		...
		// verifyImFollowingNewsStory(testUser2,
		// " commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// true);
	...
	public void testEditCommentWiki_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2, wikiNewsStory,
				FVT_NewsData.WIKIS, true);
		// verifyImFollowingNewsStory(testUser2,
		// " updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis",
		// true);
