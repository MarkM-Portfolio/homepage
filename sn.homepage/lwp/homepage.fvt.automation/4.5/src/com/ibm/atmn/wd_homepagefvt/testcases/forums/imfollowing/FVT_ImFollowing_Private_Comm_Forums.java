...
public class FVT_ImFollowing_Private_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumUpdated_PrivateComm() throws Exception {
		...
		smartSleep(FVT_ForumsObjects.Forums_Tab);
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, PrivateCommForum, null, testUser1.getDisplayName());
	...
	public void testForumTopicCreated_PrivateComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, PrivateCommTopic, PrivateCommForum, testUser1.getDisplayName());
	...
	public void testForumTopicReply_PrivateComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, PrivateCommTopic, PrivateCommForum, testUser1.getDisplayName());
	...
	public void testForumTopicUpdated_PrivateComm() throws Exception {
		...
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, PrivateCommTopic, PrivateCommForum, testUser1.getDisplayName());
	...
	public void testForumReplyUpdated_PrivateComm() throws Exception {
		...
		//Update to the reply
		updateReply2(PrivateCommForum);
		
		//Logout
		LogoutAndClose();
		
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_REPLY_THREAD, PrivateCommTopic,PrivateCommForum, null);
		//Verify news story does not appear in AS->Discover
		//verifyNewsStory(testUser2,ForumNewsStory,"I'm Following","Communities", true);
		verifyNewsStory(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.COMMUNITIES, true);
		sleep(500);
		verifyNewsStory_TwoFilters(testUser2, ForumNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, FVT_NewsData.FORUMS, false);
