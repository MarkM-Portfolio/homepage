...
public class FVT_ImFollowing_Tags_Forums extends FVT_ForumsMethods {
	...
	public void testCreateStandaloneForum() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_FORUM, part1ForumName, null, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.FORUMS, CommonData.AutomationTag, false, true);
	...
	public void testUpdateStandaloneForum() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, part1ForumName, null, testUser1.getDisplayName());
	...
	public void testCreateStandaloneForumTopic() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
	...
	public void teststandaloneForumReply() throws Exception {
		...
		//String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
	...
	public void testUpdateStandaloneForumTopic() throws Exception {
		...
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, part1TopicTitle, part1ForumName, testUser1.getDisplayName());
