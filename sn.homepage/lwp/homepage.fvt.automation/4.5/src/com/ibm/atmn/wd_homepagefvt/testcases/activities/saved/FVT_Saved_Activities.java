...
public class FVT_Saved_Activities extends FVT_ActivitiesMethods {
	...
	private static String publicActivityPublicDiscription = "";
	...
	public void testMarkingActivitySaved_Part2() throws Exception {
			...
			driver.getFirstElement(FVT_HomepageObjects.Saved_StatusUpdate).isVisible();
	...
	public void testMarkingActivityEntrySaved_Part2() throws Exception {
		...
		publicActivityPublicDiscription = addEntryToActivity_Basic(publicActivityName+" Entry",typist, false);
	...
	public void testMarkingActivityEntrySaved_Part3() throws Exception {
		...
		String temp = "css=div.activityStreamSummary div.lotusPostContent:contains('"+publicActivityPublicDiscription+"')";
		driver.getFirstElement("css=div.activityStreamSummary div.lotusPostContent:nth(0)").hover();			
		...
		driver.getFirstElement("css=div.activityStreamNewsItemContainer:nth(0)").hover();
		
		assertTrue("Fail: Link still there!!", driver.getFirstElement(FVT_NewsObjects.Saved).isVisible());			
