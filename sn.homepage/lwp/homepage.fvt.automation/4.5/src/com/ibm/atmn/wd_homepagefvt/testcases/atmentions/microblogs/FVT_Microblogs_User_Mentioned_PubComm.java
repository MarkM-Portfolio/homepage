...
public class FVT_Microblogs_User_Mentioned_PubComm extends FVT_AtMentionsMethods{
	...
	private static String PublicCommunity = "";
	 ...
	 @Test
	 public void User_Mentioned_PubComm () throws Exception {
		 
		testUser1 = userAllocator.getUser(this);
		testUser2 = userAllocator.getUser(this);
		testUser3 = userAllocator.getUser(this);
		 		
		System.out.println("INFO: Start of test_@Mention61 USER MENTIONED PUBLIC COMMUNITY");	
		...
		//verifyNewsStory( atMentionsNewsStory, "I'm Following", FVT_NewsData.STATUS_UPDATES, testUser2, true);
		...
		System.out.println("INFO: End of of test_@Mention61 USER MENTIONED PUBLIC COMMUNITY");
