...
public class FVT_ImFollowing_Tags_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testCreateANewPrivateWiki () throws Exception {
		...
		//verifyImFollowingTagsNewsStory(testUser2, " created a wiki named "+FVT_WikisData.CI_Box_Public_Wiki+".","Wikis", "automation",false, false);
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		//Replace news story string
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, false, false);
		//verifyImFollowingTagsNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis", "automation",false, false);
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		//Replace news story string
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_WIKI, FVT_WikisData.New_Child_Page_For_Private_Wiki2, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, false, false);
		//verifyImFollowingTagsNewsStory(testUser2, " updated the wiki page "+FVT_WikisData.New_Child_Page_For_Private_Wiki2+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis", "automation",false, false);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		//Replace news story string
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.Tag_For_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, false, false);
		//verifyImFollowingTagsNewsStory(testUser2, " tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis", "automation",false, false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		//Replace news story string
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_PAGE, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, false, false);
		//verifyImFollowingTagsNewsStory(testUser2, " liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis", "automation",false, false);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		//Replace news story string
		String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_WELCOME, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, false, false);
		//verifyImFollowingTagsNewsStory(testUser2, " commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis", "automation",false, false);
	...
	public void testEditCommentPrivateWiki () throws Exception {
		...
		LogoutAndClose();
	  	...
	  	verifyImFollowingTagsNewsStory(testUser2, " updated the comment on the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Wikis","automation",false, false);
