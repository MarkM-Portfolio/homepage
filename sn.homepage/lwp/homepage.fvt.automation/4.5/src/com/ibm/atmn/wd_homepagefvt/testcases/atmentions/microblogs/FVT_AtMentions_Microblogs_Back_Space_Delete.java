...
public class FVT_AtMentions_Microblogs_Back_Space_Delete extends
	...
	public void testAtMentions_15_Back_Space_Delete() throws Exception {
		...
		System.out
				.println("INFO: Start of test_At_Mentions_15_Backspace_Delete");
		...
		driver.getFirstElement(FVT_AtMentionsObjects.EmbeddedSharebox).type(
				Keys.BACK_SPACE);

		assertTrue("@Mention has not been deleted", !driver.isTextPresent("@"
