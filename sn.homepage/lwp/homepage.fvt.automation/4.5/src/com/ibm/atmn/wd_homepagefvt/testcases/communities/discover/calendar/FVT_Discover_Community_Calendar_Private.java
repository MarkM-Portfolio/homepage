...
public class FVT_Discover_Community_Calendar_Private extends FVT_CommunitiesMethods{
	...
	public void testCreateCalenderEventPart3_PrivateComm() throws Exception {
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY_CALENDAR_EVENT, CalenderEvent, PrivateCommunity, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,DiscoverNewstory, FVT_NewsData.IM_FOLLOWING_VIEW, CommonObjects.ComponentCommunities, true);
	...
	public void testEventEntryUpdated_PrivateComm() throws Exception {
		...
		//Open Community 
		openCommunity(PrivateCommunity, FVT_CommunitiesObjects.ImAnOwner, FVT_CommunitiesObjects.LeftNavEvents);
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.UPDATE_COMMUNITY_CALENDAR_EVENT, CalenderEvent, PrivateCommunity, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,DiscoverNewstory, FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.ALL, false);
		verifyNewsStory(testUser2,DiscoverNewstory, FVT_NewsData.IM_FOLLOWING_VIEW, CommonObjects.ComponentCommunities, true);
	...
	public void testEventCommentCreated_PrivateComm() throws Exception {
		...
		//Open Community 
		openCommunity(PrivateCommunity, FVT_CommunitiesObjects.ImAMember, FVT_CommunitiesObjects.LeftNavEvents);
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.COMMENT_COMMUNITY_CALENDAR_EVENT, CalenderEvent, PrivateCommunity, testUser2.getDisplayName());
	...
	public void testSeriesEntryCreated_PrivateComm() throws Exception {
		...
		RepeatingCalenderEvent = createCalendarEntry(PrivateCommunity+" Repeating Calender Event" ,true,false, null, "link=" + PrivateCommunity);
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY_CALENDAR_REPEATING_EVENT, RepeatingCalenderEvent, PrivateCommunity, testUser1.getDisplayName());
	...
	public void testSeriesEntryUpdated_PrivateComm() throws Exception {
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.UPDATE_COMMUNITY_CALENDAR_EVENT_INSTANCE, RepeatingCalenderEvent, PrivateCommunity, testUser1.getDisplayName());
	...
	public void testSeriesEntryInstanceUpdated_PrivateComm() throws Exception {
		...
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.UPDATE_COMMUNITY_CALENDAR_REPEATING_EVENT, RepeatingCalenderEvent, PrivateCommunity, testUser1.getDisplayName());
	...
	public void testEventEntryCommentDeleted_PrivateComm() throws Exception {
		...
		//Verify NewsStory
		String DiscoverNewstory = replaceNewsStory(NewsStoryData.COMMENT_COMMUNITY_CALENDAR_EVENT, CalenderEvent, PrivateCommunity, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,DiscoverNewstory, FVT_NewsData.IM_FOLLOWING_VIEW, CommonObjects.ComponentCommunities, false);
