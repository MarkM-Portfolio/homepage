...
public class FVT_ImFollowing_Tags_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PublicComm () throws Exception {
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMMUNITY, PublicWikiCommunity, null, testUser1.getDisplayName());
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
			//verifyImFollowingTagsNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testEditAWikiPage_PublicComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
			//verifyImFollowingTagsNewsStory(testUser2, " edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, FVT_WikisData.Tag_For_Public_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
			
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, false);
			//verifyImFollowingTagsNewsStory(testUser2, " commented on the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testEditCommentWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(testUser2, ImFollowingNewsStory, FVT_NewsData.WIKIS, CommonData.AutomationTag, true, true);
			//verifyImFollowingTagsNewsStory(testUser2, " updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
