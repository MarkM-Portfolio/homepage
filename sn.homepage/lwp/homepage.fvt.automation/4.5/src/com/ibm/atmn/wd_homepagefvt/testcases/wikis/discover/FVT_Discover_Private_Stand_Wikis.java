...
public class FVT_Discover_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testCreateANewPrivateWiki () throws Exception {
		...
		String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		//Replace news story string
		String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Public_Wiki, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		getActiveElement(WikisObjects.Page_Name_Textfield_In_Editor).type(FVT_WikisData.New_Child_Page_For_Private_Wiki2);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		//Replace news story string
		String WikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.CI_Box_Public_Wiki, FVT_WikisData.Tag_For_Private_Wiki, testUser1.getDisplayName());
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		//Replace news story string
		String WikiNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_WELCOME, FVT_WikisData.CI_Box_Public_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		//Replace news story string
		String WikiNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_WELCOME, FVT_WikisData.New_Peer_Page_For_Public_Wiki, FVT_WikisData.CI_Box_Public_Wiki, testUser1.getDisplayName());
