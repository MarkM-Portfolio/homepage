...
public class FVT_Microblogs_Check_For_Popup extends FVT_AtMentionsMethods{
	...
	public void test_At_Mentions_10_CheckForPopup() throws Exception {
		...
		String PopupSelected = mentionUser(testUser2, FVT_AtMentionsData.MentionUserPost, FVT_AtMentionsObjects.EmbeddedSharebox);
		...
		mentionUser(testUser2, FVT_AtMentionsData.MentionUserPost, "css=div#mentionstextAreaNode_0.lotusText");
