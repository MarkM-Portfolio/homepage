...
package com.ibm.atmn.wd_homepagefvt.testcases.blogs.imfollowing_cr1.people;
...
public class FVT_ImFollowing_People_CR1_Public_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateBlog_PublicComm() throws Exception {
		...
		smartSleep("link="+PublicBlogCommunity);
		...
		verifyNewsStory_ThreeFilters(testUser2," added a blog to the "+PublicBlogCommunity+" community.","I'm Following","Communities","People","Blogs", true);
	...
	public void testCreateBlogEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created a blog entry named "+PublicBlogEntry+" in the "+PublicBlogCommunity+" blog.","I'm Following","Communities","People","Blogs", true);
	...
	public void testUpdateBlogEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," updated the "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","I'm Following","Communities","People","Blogs", true);
	...
	public void testAddCommentToBlog_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"commented on their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","I'm Following","Communities","People","Blogs", true);
	...
	public void testCreateATrackbackTOEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"left a trackback on their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","I'm Following","Communities","People","Blogs", true);
	...
	public void testRecommendEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"liked their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","I'm Following","Communities","People","Blogs", true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"liked their own comment on "+PublicBlogEntry+".","I'm Following","Communities","People","Blogs", true);
