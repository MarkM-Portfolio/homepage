...
public class FVT_AtMentions_PubComm extends FVT_AtMentionsMethods{
	...
	@Test
	 public void Status_Update_PubComm_22 () throws Exception {
		 
		testUser1 = userAllocator.getUser(this);
		testUser2 = userAllocator.getUser(this);
		testUser3 = userAllocator.getUser(this);
		 		
		System.out.println("INFO: Start of test_@Mention22 MESSAGE DIRECTED IN A PUBLIC COMMUNITY STATUS UPDATE");	
		...
		//Verify NewsStory
		String atMentionsNewsStory = replaceNewsStory(NewsStoryData.MENTIONED_YOU_COMMUNITY, PublicCommunity, null, testUser1.getDisplayName());
	...
	@Test (dependsOnMethods = { "Status_Update_PubComm_22" })
	public void Status_Update_Comment_PubComm_32() throws Exception{
	
	
		
		System.out.println("INFO: Start of test_@Mention32 COMMENT DIRECTED IN A PUBLIC COMMUNITY STATUS UPDATE");	
		...
		//Verify NewsStory
		String atMentionsNewsStory = replaceNewsStory(NewsStoryData.MENTIONED_YOU_COMMENT_COMM, PublicCommunity, null, testUser1.getDisplayName());
		
		verifyNewsStory(atMentionsNewsStory, "@Mentions", null, testUser2, true);
		
		System.out.println("INFO: End of test_@Mention32 COMMENT DIRECTED IN A PUBLIC COMMUNITY STATUS UPDATE");
