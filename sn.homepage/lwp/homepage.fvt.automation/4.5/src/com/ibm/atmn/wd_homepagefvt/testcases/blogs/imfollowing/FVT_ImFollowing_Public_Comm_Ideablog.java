...
public class FVT_ImFollowing_Public_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testFollowPublicCommunityIdeablog() throws Exception {
			...
			assertTrue("Text not present!",driver.isTextPresent(" created the "+PublicIdeablogCommunity+" community Ideation Blog."));
			
			filterBy("Blogs");
			
			Thread.sleep(2000);
			
			assertTrue("Text is present!",driver.isTextPresent(" created the "+PublicIdeablogCommunity+" community Ideation Blog."));
	...
	public void testCreateIdea_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
	...
	public void testUpdateIdea_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.UPDATE_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
	...
	public void testAddCommentToIdea_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.COMMENT_IDEATION_BLOG_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
	...
	public void testCreateATrackbackToIdea_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_TRACKBACK_IDEATION, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
	...
	public void testIdeaVoted_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.VOTE_FOR_BLOG, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_COMMENT, PublicIdeablogEntry, null, testUser1.getDisplayName());
	...
	public void testIdeaGraduated_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.GRADUATE_IDEA, PublicIdeablogEntry, PublicIdeablogCommunity, testUser1.getDisplayName());
