...
public class FVT_ImFollowing_Tags_Private_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPrivateActivity() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, " created an activity named "+privateActivityName+".","Activities","automation", false, false);
	...
	public void testCreateStandPrivateActivity_PrivateEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, " created the "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","Activities","automation", false, false);
	...
	public void testCreateStandPrivateActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, "commented on their own "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","Activities","automation", false, false);
	...
	public void testCreateStandPrivateActivity_EditComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, " updated the comment on the "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","Activities","automation", false, false);
	...
	public void testCreateStandPrivateActivity_ToDo() throws Exception {
		...
		// Create a new to do
		privateToDoName = addToDoToActivityTags(privateActivityName+" To-Do",null, typist, false, false, testUser1);
			
		//Logout
		LogoutAndClose();
		
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, " created a to-do item named "+privateToDoName+" in the "+privateActivityName+" activity.","Activities","automation", false, false);
	...
	public void testMarkToDoAsCompleted_PrivateActivity() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, "completed their own "+privateToDoName+" to-do item in the "+privateActivityName+" activity.","Activities","automation", false, false);
