...
public class FVT_ImFollowing_Tags_Public_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_PublicComm() throws Exception {
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_FORUM, PublicCommForum, null, testUser1.getDisplayName());
	...
	public void testForumUpdated_PublicComm() throws Exception {
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_FORUM, PublicCommForum, null, testUser1.getDisplayName());
	...
	public void testForumTopicCreated_PublicComm() throws Exception {
			...
			//Verify news story appears in AS->Discover
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_TOPIC, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
	...
	public void testForumTopicReply_PublicComm() throws Exception {
			...
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.CREATE_REPLY, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
	...
	public void testForumTopicUpdated_PublicComm() throws Exception {
			...
			//Verify news story appears in AS->Discover
			String ImFollowingNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, PublicCommTopic, PublicCommForum, testUser1.getDisplayName());
