...
public class FVT_ImFollowing_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testFollowWiki() throws Exception {
			...
			//Follow Wiki
			followWiki(FVT_WikisData.CI_Box_Private_Wiki,"Private");
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.WIKIS, true);
		//verifyNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Child_Page_For_Private_Wiki2, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW, FVT_NewsData.WIKIS, false);
		//verifyNewsStory(testUser2, " edited the wiki page "+FVT_WikisData.New_Child_Page_For_Private_Wiki2+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.Tag_For_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.WIKIS, false);
		//verifyNewsStory(testUser2, " tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_WELCOME, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.WIKIS, false);
		//verifyNewsStory(testUser2, " liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_WELCOME, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.WIKIS, true);
		//verifyNewsStory(testUser2, " commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testEditCommentPrivateWiki () throws Exception {
		...
		String wikiNewsStory = replaceNewsStory(NewsStoryData.UPDATE_WIKI_PAGE, FVT_WikisData.CI_Box_Private_Wiki, FVT_WikisData.CI_Box_Private_Wiki, testUser1.getDisplayName());
		
		verifyNewsStory(testUser2,wikiNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.WIKIS, true);
		//verifyNewsStory(testUser2, "updated the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
