...
public class FVT_Discover_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PublicComm () throws Exception {
			...
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_COMMUNITY, PublicWikiCommunity, null, testUser1.getDisplayName());
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.CREATE_WIKI_PAGE, FVT_WikisData.New_Child_Page_For_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
		...
		public void testEditAWikiPage_PublicComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.EDIT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.TAG_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, FVT_WikisData.Tag_For_Public_Wiki, testUser1.getDisplayName());
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.LIKE_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			//Replace news story string
			String WikiNewsStory = replaceNewsStory(NewsStoryData.COMMENT_WIKI_PAGE, FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki, PublicWikiCommunity, testUser1.getDisplayName());
