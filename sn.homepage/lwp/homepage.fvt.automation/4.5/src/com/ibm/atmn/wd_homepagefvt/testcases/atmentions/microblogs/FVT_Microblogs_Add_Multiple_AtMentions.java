...
public class FVT_Microblogs_Add_Multiple_AtMentions extends FVT_AtMentionsMethods {
	...
	public void Add_Multiple_AtMentions_003 () throws Exception {
		...
		driver.getSingleElement(FVT_AtMentionsObjects.EmbeddedSharebox).type("This is an FVT_AtMentions test post " + DateTimeStamp);
		
		//Enter 5 users with @Mentions
		for(int x = 0; x <= 4;){
			
				mentionMultipleUsers(users[x], FVT_AtMentionsData.MentionUserPost, FVT_AtMentionsObjects.EmbeddedSharebox );
