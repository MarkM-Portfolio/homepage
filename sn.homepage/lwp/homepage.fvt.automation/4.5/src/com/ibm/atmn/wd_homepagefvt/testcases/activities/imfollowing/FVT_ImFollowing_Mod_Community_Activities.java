...
public class FVT_ImFollowing_Mod_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testFollowModCommunityActivity() throws Exception {
			...
			clickLink(FVT_CommunitiesObjects.LeftNavActivities);
	...
	public void testCreateActivityEntry_ModComm() throws Exception {
		...
		addEntryToActivity_Basic(ModeratedCommunityActivity +" Entry",typist, false);
		ModeratedActivityEntry = ModeratedCommunityActivity +" Entry";
		...
		//verifyImFollowingNewsStory(testUser2," created the "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityComment_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2, activityNewsStory, FVT_NewsData.ACTIVITIES, true);
		//verifyImFollowingNewsStory(testUser2,"commented on the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","Activities", true);
	...
	public void testEditActivityComment_ModComm() throws Exception {
		...
		String activityNewsStory = replaceNewsStory(NewsStoryData.UPDATE_ACTIVITY_ENTRY, ModeratedActivityEntry, ModeratedCommunityActivity, testUser1.getDisplayName());
		...
		//verifyImFollowingNewsStory(testUser2,"updated the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityToDo_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2, activityNewsStory, FVT_NewsData.ACTIVITIES, true);		
		//verifyImFollowingNewsStory(testUser2," created a to-do item named "+ModActivityToDo+" in the "+ModeratedCommunityActivity+" activity.","Activities", true);
	...
	public void testMarkToDoAsCompleted_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2, activityNewsStory, FVT_NewsData.ACTIVITIES, true);		
		//verifyImFollowingNewsStory(testUser2,"completed their own "+ModActivityToDo+" to-do item in the "+ModeratedCommunityActivity+" activity.","Activities", true);
