...
public class FVT_Discover_Blogs extends FVT_BlogsMethods{
	...
	public void testCreateStandAloneBlogEntry_Draft() throws Exception{
		...
		//Wait for "New Entry" button
		//smartSleep(FVT_BlogsObjects.BlogsNewEntry);
	...
	//@Test (dependsOnMethods = { "testRecommendStandaloneEntry" }, groups = { "brokenIE"})
