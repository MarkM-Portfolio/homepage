...
public class FVT_StatusUpdates_RollUp extends FVT_CommonNewsMethods{
	...
	public void testRollUp_SingleComment() throws Exception {
		...
		assertTrue("FAIL: Sharebox not visible", driver.isElementPresent(FVT_NewsObjects.EnterStatusUpdate_txt));
	...
	public void testRollUp_TwoComments() throws Exception {
		...
		System.out.println(testUser3.getDisplayName());
		System.out.println(testUser4.getDisplayName());
		System.out.println(testUser5.getDisplayName());
		...
		assertTrue("Rollup text not present", driver.isTextPresent(testUser4.getDisplayName()+" commented on your message."));
		...
		assertTrue("Rollup text not present", driver.isTextPresent(testUser5.getDisplayName()+" commented on "+testUser3.getDisplayName()+"'s message."));
		...
		assertTrue("Rollup text not present", driver.isTextPresent(testUser4.getDisplayName()+" commented on "+testUser3.getDisplayName()+"'s message."));
