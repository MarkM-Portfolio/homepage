...
public class FVT_ImFollowing_Tags_Mod_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created an activity named "+ModeratedCommunityActivity+".","Activities","automation", true, true);
	...
	public void testCreateActivityEntry_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" commented on their own "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testEditActivityComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("updated the comment on the "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityToDo_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a to-do item named "+ModActivityToDo+" in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testMarkToDoAsCompleted_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("completed their own "+ModActivityToDo+" to-do item in the "+ModeratedCommunityActivity+" activity.","Activities","automation", true, true);
