...
public class WikisObjects {
	...
	public static final String My_Wikis_Tab = "link=Wikis";
	...
	/*
	 * public static final List<String> PAGETITLES = Arrays.asList("Wikis" , "Create a New Wiki" , "All Wikis - Wikis" ,
	 * "Public Wikis" , "My Wikis");
	 * 
	 * public static final List<String> InvalidChars = Arrays.asList("Wikis" , "Create a New Wiki" , "All Wikis - Wikis"
	 * , "Public Wikis" , "My Wikis");
	 */
