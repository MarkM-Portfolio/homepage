...
public class FVT_Level2_Saved_Forums extends FVT_ForumsMethods {
	...
	public void testMarkingForumsStoriesAsSaved() throws Exception {
		...
		assertTrue("Fail: text is not present!!", sel.isTextPresent("created the "+part1ForumName+" forum."));
	...
	@Test (dependsOnMethods = { "testMarkingForumsStoriesAsSaved" })
	public void testMarkingForumsStoriesAsSavedPart2() throws Exception {
		...
		assertTrue("Fail: text is not present!!", sel.isTextPresent("created a new topic named "+part1TopicTitle+" in the "+part1ForumName+" forum."));
	...
	@Test (dependsOnMethods = { "testMarkingForumsStoriesAsSavedPart2" })
	public void testMarkingForumsStoriesAsSavedPart3() throws Exception {
		...
		assertTrue("Fail: text is not present!!", sel.isTextPresent("about the Re: "+part1TopicTitle+" topic in the "+part1ForumName+" forum."));
