...
public class FVT_Discover_Public_Comm_Blogs extends FVT_BlogsMethods{
	...
	public void testCreateBlog_PublicComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMM_BLOG, PublicBlogCommunity, null, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testCreateBlogEntry_PublicComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_BLOG_ENTRY, PublicBlogEntry, PublicBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testAddCommentToBlog_PublicComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_COMMENT_BLOG_ENTRY, PublicBlogEntry, PublicBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testCreateATrackbackTOEntry_PublicComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_TB_BLOG_ENTRY, PublicBlogEntry, PublicBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testRecommendEntry_PublicComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_ENTRY, PublicBlogEntry, PublicBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_COMMENT, PublicBlogEntry, PublicBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
