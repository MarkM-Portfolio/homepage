...
public class FVT_ImFollowing_Tags_Mod_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_ModComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created the "+ModeratedCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumUpdated_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+ModeratedCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumTopicCreated_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a topic named "+ModeratedCommTopic+" in the "+ModeratedCommForum+" forum.","Forums","automation", true, true);	
	...
	public void testForumTopicReply_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("replied to their own Re: "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumTopicUpdated_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.","Forums","automation", true, true);
