...
public class FVT_ImFollowing_Tags_Mod_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateBlog_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a blog named "+ModeratedBlogCommunity+".","Blogs","automation", true, true);
	...
	public void testCreateBlogEntry_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory(" created a blog entry named "+ModeratedBlogEntry+" in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testUpdateBlogSettings_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory(" updated the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testUpdateBlogEntry_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testAddCommentToBlog_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("commented on their own "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testCreateATrackbackToEntry_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("left a trackback on their own RE: "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendEntry_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory("liked their own "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory("liked their own comment on "+ModeratedBlogEntry+".","Blogs","automation",true, true);
