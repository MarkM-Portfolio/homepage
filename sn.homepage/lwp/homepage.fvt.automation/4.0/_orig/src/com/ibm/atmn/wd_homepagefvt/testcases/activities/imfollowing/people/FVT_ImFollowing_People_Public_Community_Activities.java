...
public class FVT_ImFollowing_People_Public_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PublicComm() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created an activity named "+PublicCommunityActivity+".","I'm Following","People","Activities", true);
	...
	public void testCreateActivityEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created the "+PublicActivityEntry+" entry in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityPrivateEntry_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created the "+PublicActivityPrivateEntry+" entry in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testCreateActivityComment_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("commented on the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testEditActivityComment_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("updated the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityPrivateComment_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("commented on the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testCreateActivityToDo_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created a to-do item named "+PublicActivityToDo+" in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testMarkToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("completed their own "+PublicActivityToDo+" to-do item in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityPrivateToDo_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created a to-do item named "+PublicActivityPrivateToDo+" in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testMarkPrivateToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("completed their own "+PublicActivityPrivateToDo+" to-do item in the "+PublicCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
