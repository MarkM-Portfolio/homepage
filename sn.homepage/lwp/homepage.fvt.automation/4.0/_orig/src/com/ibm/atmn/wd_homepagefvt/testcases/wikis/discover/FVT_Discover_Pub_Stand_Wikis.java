...
public class FVT_Discover_Pub_Stand_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewPublicWiki () throws Exception {
			...
			//
			verifyNewsStory(" created a wiki named "+FVT_WikisData.CI_Box_Public_Wiki+".","Discover","Wikis", true);
		...
		public void testAddPagesToPublicWiki () throws Exception {
			...
			//
			verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		public void testAddATagToPublicWiki() throws Exception {
			...
			verifyNewsStory(" tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", false);
		...
		public void testRecommendAPageForPublicWiki () throws Exception {
			...
			verifyNewsStory(" liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		public void testAddCommentToPublicWiki () throws Exception {
			...
			verifyNewsStory(" commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		public void testDeletePublicWiki () throws Exception {
			...
			//Delete Wiki
			deleteThisWiki(CommonData.IC_LDAP_Username_Fullname450);
