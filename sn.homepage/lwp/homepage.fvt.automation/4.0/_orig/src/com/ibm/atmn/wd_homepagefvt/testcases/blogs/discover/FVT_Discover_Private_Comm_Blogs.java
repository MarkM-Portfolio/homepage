...
public class FVT_Discover_Private_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateBlog_PrivateComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMM_BLOG, PrivateBlogCommunity, null, CommonData.IC_LDAP_Username_Fullname450);
		...
		//verifyNewsStory(" created a blog named "+PrivateBlogCommunity+".","Discover","Blogs", false);
	...
	public void testCreateBlogEntry_PrivateComm() throws Exception {
			...
			//Replace news story string
			String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_BLOG_ENTRY, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
			
			//Verify that news story appears in  Activity Steam -> Discover;
			verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, false);
			
			//verifyNewsStory(" created a blog entry named "+PrivateBlogEntry+" in the "+PrivateBlogCommunity+" blog.","Discover","Blogs", false);
	...
	public void testUpdateBlogEntry_PrivateComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BLOG_ENTRY, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testAddCommentToBlog_PrivateComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_COMMENT_BLOG_ENTRY, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testCreateATrackbackTOEntry_PrivateComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_TB_BLOG_ENTRY, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testRecommendEntry_PrivateComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_ENTRY, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, false);
		
		//verifyNewsStory("liked their own "+PrivateBlogEntry+" blog entry in the "+PrivateBlogCommunity+" blog.","Discover","Blogs", false);
	...
	public void testRecommendComment_PrivateComm() throws Exception {
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_COMMENT, PrivateBlogEntry, PrivateBlogCommunity, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, false);
		
		//verifyNewsStory("liked their own comment on "+PrivateBlogEntry+".","Discover","Blogs", false);
