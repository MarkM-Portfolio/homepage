...
public class FVT_ImFollowing_People_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters("A "+PublicWikiCommunity+" community wiki was created.","I'm Following","Communities","People","Wikis", true);
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditAWikiPage_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", false);
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditCommentWiki_PublicComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" updated wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
