...
public class FVT_Discover_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" commented on the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","Discover","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" commented on the "+publicEntryTitle+" entry thread in the "+publicActivityName+" activity.","Discover","Activities", false);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("assigned themselves a to-do item named "+publicAssignedToDoName+" in the "+publicActivityName+" activity.","Discover","Activities", true);
	...
	public void testMiscellaneousParentActivityRename() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("completed their own "+publicAssignedToDoName+" to-do item in the Edited FVT Automation Activity activity.","Discover","Activities", true);
