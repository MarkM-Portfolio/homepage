...
public class FVT_ImFollowing_Tags_Private_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created an activity named "+PrivateCommunityActivity+".","Activities","automation", true, false);
	...
	public void testCreateActivityEntry_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testCreateActivityComment_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("commented on their own "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testEditActivityComment_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the comment on the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testCreateActivityToDo_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a to-do item named "+PrivateActivityToDo+" in the "+PrivateCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testMarkToDoAsCompleted_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("completed their own "+PrivateActivityToDo+" to-do item in the "+PrivateCommunityActivity+" activity.","Activities","automation", true, false);
