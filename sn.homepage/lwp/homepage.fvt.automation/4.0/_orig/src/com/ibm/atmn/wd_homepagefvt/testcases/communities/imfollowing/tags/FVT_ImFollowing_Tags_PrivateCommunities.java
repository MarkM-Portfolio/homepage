...
public class FVT_ImFollowing_Tags_PrivateCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreatePrivateComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created a community named "+PrivateCommunity+".","Communities","automation",false, false);
	...
	public void testCreateFeed_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" added the "+PrivateCommFeed+" feed to the "+PrivateCommunity+" community.","Communities","automation",false, false);
	...
	public void testAddBookmark_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" added the "+PrivateCommBookmark+" bookmark to the "+PrivateCommunity+" community.","Communities","automation",false, false);
	...
	public void testUpdateBookmark_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+PrivateCommBookmark+" bookmark in the "+PrivateCommunity+" community.","Communities","automation",false, false);
