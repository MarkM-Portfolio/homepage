...
public class FVT_ImFollowing_Tags_Dogear extends FVT_DogearMethods {
	...
	public void testPrivateBookmarkAdded() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a bookmark named "+PRIVATE_BOOKMARK_NAME+".","Bookmarks","automation", false, false);
	...
	public void testPrivateBookmarkEdited() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyImFollowingTagsNewsStory(" updated the bookmark named "+PRIVATE_BOOKMARK_NAME+".","Bookmarks","automation", false, false);
	...
	public void testPublicBookmarkAdded() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyImFollowingTagsNewsStory(" created a bookmark named "+PUBLIC_BOOKMARK_NAME+".","Bookmarks","automation", false, true);		
	...
	public void testPublicBookmarkEdited() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyImFollowingTagsNewsStory(" updated the bookmark named "+PUBLIC_BOOKMARK_NAME+".","Bookmarks","automation", false, true);		
	...
	public void testAddTagToWatchlist() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyImFollowingTagsNewsStory(" added the following tag to their Bookmarks watchlist: fvttesttag","Bookmarks","automation", false, false);		
