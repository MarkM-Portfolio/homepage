...
public class FVT_ImFollowing_Priv_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWikiPage_PrivateComm () throws Exception {
			...
			verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Wikis", true);
		...
		public void testEditAWikiPage_PrivateComm () throws Exception {
			...
			verifyImFollowingNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddATagToWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", false);
		...
		public void testRecommendAWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddCommentToWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditCommentWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingNewsStory("updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", true);
