...
public class FVT_Discover_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testCreateANewPrivateWiki () throws Exception {
		...
		verifyNewsStory(" created a wiki named "+FVT_WikisData.CI_Box_Private_Wiki+".","Discover","Wikis", false);
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Discover","Wikis", false);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		verifyNewsStory(" tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Discover","Wikis", false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		verifyNewsStory(" liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Discover","Wikis", false);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		verifyNewsStory(" commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","Discover","Wikis", false);
