...
public class FVT_ImFollowing_People_Pub_Stand_Wikis extends FVT_WikisMethods{
	...
	private static String USER_2_TYPEAHEAD = CommonData.IC_LDAP_UserName451_Typeahead;
		...
		public void testCreateANewPublicWiki () throws Exception {
			...
			//
			verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created a wiki named "+FVT_WikisData.CI_Box_Public_Wiki+".","I'm Following","Wikis","People", true);
		...
		public void testAddPagesToPublicWiki () throws Exception {
			...
			//
			verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", true);
		...
		public void testEditPageInPublicWiki () throws Exception {
			...
			//VerifyAddedContentInHomepage(FVT_WikisData.New_Content_For_Public_Wiki, CommonData.IC_LDAP_Username450);
		  	...
		  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Public_Wiki2+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", true);
		...
		public void testAddATagToPublicWiki() throws Exception {
			...
			Assert.assertTrue("FAIL: Tag hasn't been added correctly", driver.isTextPresent(FVT_WikisData.Tag_For_Public_Wiki)); 
		  	...
		  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", false);
		...
		public void testRecommendAPageForPublicWiki () throws Exception {
			...
			LikeCurrentPage();
		  	...
		  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", true);
		...
		public void testAddCommentToPublicWiki () throws Exception {
			...
			VerifyCommentIsAdded(FVT_WikisData.Comment_For_Public_Wiki);
		  	...
		  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", true);
		...
		public void testEditCommentPublicWiki () throws Exception {
			...
			VerifyCommentIsAdded(FVT_WikisData.Comment_For_Public_Wiki);
		  	...
		  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS,"updated the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis","People", true);
