...
public class FVT_ImFollowing_Tags_Public_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateBlog_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a blog named "+PublicBlogCommunity+".","Blogs","automation", true, true);
	...
	public void testCreateBlogEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a blog entry named "+PublicBlogEntry+" in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testUpdateBlogSettings_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testUpdateBlogEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testAddCommentToBlog_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("commented on their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testCreateATrackbackTOEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("left a trackback on their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("liked their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("liked their own comment on "+PublicBlogEntry+".","Blogs","automation",true, true);
