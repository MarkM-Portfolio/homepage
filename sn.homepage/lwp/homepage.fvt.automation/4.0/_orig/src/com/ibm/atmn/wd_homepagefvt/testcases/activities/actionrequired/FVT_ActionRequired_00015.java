...
public class FVT_ActionRequired_00015 extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity() throws Exception {
			...
			PublicActivityName = startAnActivity(FVT_ActivitiesData.Start_Public_Activity_InputText_Name_Data+genDateBasedRandVal(),typist,testUser2.getDisplayName());
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		// Create a new to do
		PublicAssignedToDoName = addToDoToActivity(PublicActivityName+" Assigned To-Do",typist, false, true, testUser2.getDisplayName());
	...
	public void testCreateStandPrivateActivity() throws Exception {
			...
			PrivateActivityName = startAnActivity(FVT_ActivitiesData.Start_Private_Activity_InputText_Name_Data+genDateBasedRandVal(),typist,testUser2.getDisplayName());
	...
	public void testCreateStandPrivateActivity_AssignedToDo() throws Exception {
		...
		// Create a new to do
		PrivateAssignedToDoName = addToDoToActivity(PrivateActivityName+" Assigned To-Do",typist, false, true, testUser2.getDisplayName());
	...
	public void testVerifyBadgeIsPresent() throws Exception {
			...
			assertTrue("FAIL: Number of stories not equal to '2'", driver.getSingleElement(FVT_NewsObjects.ActionRequiredBadge).getText().compareToIgnoreCase("2") == 0);
