...
public class FVT_ImFollowing_Tags_Pub_Stand_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewPublicWiki () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created a wiki named "+FVT_WikisData.CI_Box_Public_Wiki+".","Wikis", "automation",false, true);
		...
		public void testAddPagesToPublicWiki () throws Exception {
			...
			//
			verifyImFollowingTagsNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Wikis", "automation",false, true);
		...
		public void testEditPageInPublicWiki () throws Exception {
			...
			//VerifyAddedContentInHomepage(FVT_WikisData.New_Content_For_Public_Wiki, CommonData.IC_LDAP_Username450);
		  	...
		  	verifyImFollowingTagsNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Public_Wiki2+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Wikis", "automation",false, true);
		...
		public void testAddATagToPublicWiki() throws Exception {
			...
			Assert.assertTrue("FAIL: Tag hasn't been added correctly", driver.isTextPresent(FVT_WikisData.Tag_For_Public_Wiki)); 
		  	...
		  	verifyImFollowingTagsNewsStory(" tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Wikis", "automation",false, false);
		...
		public void testRecommendAPageForPublicWiki () throws Exception {
			...
			LikeCurrentPage();
		  	...
		  	verifyImFollowingTagsNewsStory(" liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following", "automation",false, true);
		...
		public void testAddCommentToPublicWiki () throws Exception {
			...
			VerifyCommentIsAdded(FVT_WikisData.Comment_For_Public_Wiki);
		  	...
		  	verifyImFollowingTagsNewsStory(" commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Wikis", "automation",false, true);
		...
		public void testEditCommentPublicWiki () throws Exception {
			...
			VerifyCommentIsAdded(FVT_WikisData.Comment_For_Public_Wiki);
		  	...
		  	verifyImFollowingTagsNewsStory("updated the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Wikis","automation",false, true);
