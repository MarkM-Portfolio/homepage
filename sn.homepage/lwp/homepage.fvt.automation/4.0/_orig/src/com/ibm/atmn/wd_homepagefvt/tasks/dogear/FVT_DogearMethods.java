...
public class FVT_DogearMethods extends FVT_CommonNewsMethods {
	...
	public void notifyUserAboutBookmark(String UserTypeAhead) {
		...
		clickLink(FVT_DogearObjects.NotifyDropDown);
		
		clickLink(FVT_DogearObjects.NotifyDropDownPerson1);
		//clickLink(FVT_DogearObjects.NotifyDropDownPerson+":contains('"+UserTypeAhead+"')");
