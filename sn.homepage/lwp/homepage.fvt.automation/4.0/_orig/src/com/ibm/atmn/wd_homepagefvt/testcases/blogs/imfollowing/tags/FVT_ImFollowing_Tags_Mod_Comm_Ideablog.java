...
public class FVT_ImFollowing_Tags_Mod_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testCreateIdeablog_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created an Ideation Blog named "+ModeratedIdeablogCommunity+".","Blogs","automation",true, true);
	...
	public void testCreateIdea_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testUpdateIdea_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testAddCommentToIdea_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("commented on their own "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testCreateATrackbackToIdea_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("left a trackback on their own RE: "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testIdeaVoted_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" voted for the "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("liked their own comment on "+ModeratedIdeablogEntry+".","Blogs","automation",true, true);
	...
	public void testIdeaGraduated_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("graduated their own "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
