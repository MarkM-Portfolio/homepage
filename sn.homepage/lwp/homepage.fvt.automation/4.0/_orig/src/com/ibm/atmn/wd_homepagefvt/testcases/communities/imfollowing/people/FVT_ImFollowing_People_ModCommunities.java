...
public class FVT_ImFollowing_People_ModCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateFeed_ModComm() throws Exception {
			...
			verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," added the "+ModeratedCommFeed+" feed to the "+ModeratedCommunity+" community.","I'm Following","Communities","People", true);
	...
	public void testAddBookmark_ModComm() throws Exception {
			...
			verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," added the "+ModeratedCommBookmark+" bookmark to the "+ModeratedCommunity+" community.","I'm Following","Communities","People", true);
	...
	public void testUpdateBookmark_ModComm() throws Exception {
			...
			verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," updated the "+ModeratedCommBookmark+" bookmark in the "+ModeratedCommunity+" community.","I'm Following","Communities","People", true);
