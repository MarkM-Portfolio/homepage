...
public class FVT_ImFollowing_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testFollowPublicActivity() throws Exception {
			...
			verifyNewsStory(" created a public activity named "+publicActivityName+".","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_PublicEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" created the "+publicActivityPublicEntryTitle+" entry in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("commented on the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_EditComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" updated the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" created the "+publicActivityPrivateEntryTitle+" entry in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_PrivateComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("commented on the "+publicEntryTitle+" entry thread in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_ToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" created a to-do item named "+publicToDoName+" in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testMarkToDoAsCompleted_PublicActivity() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("completed their own "+publicToDoName+" to-do item in the "+publicActivityName+" activity.","I'm Following","Activities", true);
	...
	public void testCreateStandPublicActivity_PrivateToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory(" created a to-do item named "+publicActivityPrivateToDoName+" in the "+publicActivityName+" activity.","I'm Following","Activities", false);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyNewsStory("assigned themselves a to-do item named "+publicAssignedToDoName+" in the "+publicActivityName+" activity.","I'm Following","Activities", true);
