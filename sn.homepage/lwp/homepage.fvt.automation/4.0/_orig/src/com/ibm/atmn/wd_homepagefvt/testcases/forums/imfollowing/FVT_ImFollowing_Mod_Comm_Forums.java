...
public class FVT_ImFollowing_Mod_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumUpdated_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(" updated the "+ModeratedCommForum+" forum.","Forums", true);
	...
	public void testForumTopicCreated_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a topic named "+ModeratedCommTopic+" in the "+ModeratedCommForum+" forum.","Forums", true);	
	...
	public void testForumTopicReply_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory("commented on the Re: "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","Forums", true);
	...
	public void testForumTopicUpdated_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(" updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.","Forums", true);
	...
	public void testForumTopicReplyUpdated_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(" updated the "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","Forums", true);
