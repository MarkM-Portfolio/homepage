...
public class FVT_ImFollowing_PrivateCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateFeed_PrivateComm() throws Exception {
		...
		verifyNewsStory(" added the "+PrivateCommFeed+" feed to the "+PrivateCommunity+" community.","I'm Following","Communities", true);
	...
	public void testAddBookmark_PrivateComm() throws Exception {
		...
		verifyNewsStory(" added the "+PrivateCommBookmark+" bookmark to the "+PrivateCommunity+" community.","I'm Following","Communities", true);
	...
	public void testUpdateBookmark_PrivateComm() throws Exception {
		...
		verifyNewsStory(" updated the "+PrivateCommBookmark+" bookmark in the "+PrivateCommunity+" community.","I'm Following","Communities", true);
