...
public class FVT_ImFollowing_Tags_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created an activity named "+publicActivityName+".","Activities","automation",false, false);
	...
	public void testCreateStandPublicActivity_PublicEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(" created the "+publicActivityPublicEntryTitle+" entry in the "+publicActivityName+" activity.","Activities","automation",false, true);
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory("commented on their own "+publicActivityPublicEntryTitle+" entry in the "+publicActivityName+" activity.","Activities","automation", false, true);
	...
	public void testCreateStandPublicActivity_EditComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(" updated the comment on the "+publicActivityPublicEntryTitle+" entry in the "+publicActivityName+" activity.","Activities","automation", false, true);
	...
	public void testCreateStandPublicActivity_PrivateEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(" created the "+publicActivityPrivateEntryTitle+" entry in the "+publicActivityName+" activity.","Activities","automation", false, false);
	...
	public void testCreateStandPublicActivity_ToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(" created a to-do item named "+publicToDoName+" in the "+publicActivityName+" activity.","Activities","automation",false,  true);
	...
	public void testMarkToDoAsCompleted_PublicActivity() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory("completed their own "+publicToDoName+" to-do item in the "+publicActivityName+" activity.","Activities","automation", false, true);
	...
	public void testCreateStandPublicActivity_PrivateToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(" created a to-do item named "+publicActivityPrivateToDoName+" in the "+publicActivityName+" activity.","Activities","automation", false, false);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory("assigned themselves a to-do item named "+publicAssignedToDoName+" in the "+publicActivityName+" activity.","Activities","automation", false, true);
