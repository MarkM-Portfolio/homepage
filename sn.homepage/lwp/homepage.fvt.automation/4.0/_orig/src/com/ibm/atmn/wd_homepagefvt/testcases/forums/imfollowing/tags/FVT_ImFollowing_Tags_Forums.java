...
public class FVT_ImFollowing_Tags_Forums extends FVT_ForumsMethods {
	...
	public void testCreateStandaloneForum() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+part1ForumName+" forum.","Forums","automation",false, true);
	...
	public void testUpdateStandaloneForum() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+part1ForumName+" forum.","Forums","automation",false, true);
	...
	public void testCreateStandaloneForumTopic() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a topic named "+part1TopicTitle+" in the "+part1ForumName+" forum.","Forums","automation",false, true);
	...
	public void teststandaloneForumReply() throws Exception {
		...
		verifyImFollowingTagsNewsStory("replied to their own Re: "+part1TopicTitle+" topic in the "+part1ForumName+" forum.","Forums","automation",false, true);
	...
	public void testUpdateStandaloneForumTopic() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+part1TopicTitle+" topic in the "+part1ForumName+" forum.","Forums","automation",false, true);
