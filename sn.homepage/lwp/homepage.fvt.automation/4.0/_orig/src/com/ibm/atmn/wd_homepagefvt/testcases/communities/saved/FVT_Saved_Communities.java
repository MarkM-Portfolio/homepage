...
public class FVT_Saved_Communities extends FVT_CommunitiesMethods {
	...
	private static String PublicCommunity = "Public Level 2 FVT Community 1131111535";
	private static String PublicCalendarEntry = "FVT Calendar Event 1131111954";
	...
	public void testMarkingCommunitiesStoriesAsSavedPart3() throws Exception {
		...
		//Open Calendar
		openCommunity(PublicCommunity, FVT_CommunitiesObjects.PublicCommunityView, FVT_CommunitiesObjects.LeftNavCalendar);
		...
		driver.getSingleElement("css=div.lotusPostContent:contains('commented on the event "+PublicCalendarEntry+" in the "+PublicCommunity+" community.')").hover();
