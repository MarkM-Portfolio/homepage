...
public class FVT_ImFollowing_Public_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		//verifyImFollowingNewsStory("liked their own comment on "+PublicBlogEntry+".","Blogs", true);
