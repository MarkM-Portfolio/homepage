...
public class FVT_ImFollowing_Tags_Priv_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory("A "+PrivateWikiCommunity+" community wiki was created.","Wikis","automation", true, false);
		...
		public void testCreateANewWikiPage_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis","automation", true, false);
		...
		public void testEditAWikiPage_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testAddATagToWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testRecommendAWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testAddCommentToWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testEditCommentWiki_PrivateComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory("updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Wikis", "automation", true, false);
