...
public class FVT_ImFollowing_Pub_Stand_Wikis extends FVT_WikisMethods{
		...
		public void testAddPagesToPublicWiki () throws Exception {
			...
			//
			verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", true);
		...
		public void testEditPageInPublicWiki () throws Exception {
			...
			verifyNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Public_Wiki2+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", true);
		...
		public void testAddATagToPublicWiki() throws Exception {
			...
			verifyNewsStory(" tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", false);
		...
		public void testRecommendAPageForPublicWiki () throws Exception {
			...
			verifyNewsStory(" liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", true);
		...
		public void testAddCommentToPublicWiki () throws Exception {
			...
			verifyNewsStory(" commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", true);
		...
		public void testEditCommentPublicWiki () throws Exception {
			...
			verifyNewsStory("updated the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","I'm Following","Wikis", true);
