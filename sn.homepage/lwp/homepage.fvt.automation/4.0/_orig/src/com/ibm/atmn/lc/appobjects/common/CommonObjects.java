...
public class CommonObjects {
	...
	private static final String APP_PROPERTIES_PATH = "/com/ibm/atmn/lc/config/app.properties";
	private static final Properties appProperties = FileIOHandler.getProperties(APP_PROPERTIES_PATH);

	//URL for testing 
	public static final String ComponentActivities = appProperties.getProperty("test_component_activities");
	public static final String ComponentBlogs = appProperties.getProperty("test_component_blogs");
	public static final String ComponentCommunities = appProperties.getProperty("test_component_communities");
	public static final String ComponentDogear = appProperties.getProperty("test_component_dogear");
	public static final String ComponentFiles = appProperties.getProperty("test_component_files");
	public static final String ComponentForums = appProperties.getProperty("test_component_forums");
	public static final String ComponentHomepage = appProperties.getProperty("test_component_homepage");
	public static final String ComponentGlobalSearch = appProperties.getProperty("test_component_globalsearch");
	public static final String ComponentMobile = appProperties.getProperty("test_component_mobile");
	public static final String ComponentModeration = appProperties.getProperty("test_component_moderation");
	public static final String ComponentNews = appProperties.getProperty("test_component_news");
	public static final String ComponentProfiles = appProperties.getProperty("test_component_profiles");
	public static final String ComponentWikis = appProperties.getProperty("test_component_wikis");
	public static final String ComponentMetrics = appProperties.getProperty("test_component_metrics");

	//Browser timeout
	public static final String browserTimeout = appProperties.getProperty("test_timeout");
	public static final String browserSleep = appProperties.getProperty("test_sleep");
	...
	public static final String StartButton = "css=span#createPlaceButton.lotusBtn a";
