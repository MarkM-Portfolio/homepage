...
public class FVT_ImFollowing_Tags_Public_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created an activity named "+PublicCommunityActivity+".","Activities","automation", true, true);
	...
	public void testCreateActivityEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+PublicActivityEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityPrivateEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created the "+PublicActivityPrivateEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities","automation", true, false);
	...
	public void testCreateActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("commented on their own "+PublicActivityEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testEditActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("updated the comment on the "+PublicActivityEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityToDo_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a to-do item named "+PublicActivityToDo+" in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testMarkToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory("completed their own "+PublicActivityToDo+" to-do item in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityPrivateToDo_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" created a to-do item named "+PublicActivityPrivateToDo+" in the "+PublicCommunityActivity+" activity.","Activities","automation", true, false);
