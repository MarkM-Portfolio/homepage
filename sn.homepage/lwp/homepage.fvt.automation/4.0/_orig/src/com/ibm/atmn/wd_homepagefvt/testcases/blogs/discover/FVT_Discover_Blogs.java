...
public class FVT_Discover_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateStandAloneBlog() throws Exception{
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_BLOG, StandaloneBlogName, null, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testCreateStandAloneBlogEntry_Draft() throws Exception{
		...
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, false);
