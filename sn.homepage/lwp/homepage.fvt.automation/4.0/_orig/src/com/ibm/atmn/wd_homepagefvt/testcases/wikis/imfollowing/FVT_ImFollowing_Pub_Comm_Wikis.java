...
public class FVT_ImFollowing_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditAWikiPage_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", false);
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditCommentWiki_PublicComm () throws Exception {
			...
			verifyImFollowingNewsStory(" updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", true);
