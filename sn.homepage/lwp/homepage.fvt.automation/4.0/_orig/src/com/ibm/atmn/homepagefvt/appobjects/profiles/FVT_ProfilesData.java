...
public class FVT_ProfilesData {
	...
	public static final String ProfilesBoardEntry = "I am currently working on the selenium level 2 FVT testcases for Profiles" +CommonMethods.genDateBasedRandVal();
