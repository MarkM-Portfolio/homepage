...
public class FVT_ImFollowing_Tags_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory("A "+PublicWikiCommunity+" community wiki was created.","Wikis","automation", true, true);
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testEditAWikiPage_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, false);
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" commented on the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
		...
		public void testEditCommentWiki_PublicComm () throws Exception {
			...
			verifyImFollowingTagsNewsStory(" updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Wikis", "automation", true, true);
