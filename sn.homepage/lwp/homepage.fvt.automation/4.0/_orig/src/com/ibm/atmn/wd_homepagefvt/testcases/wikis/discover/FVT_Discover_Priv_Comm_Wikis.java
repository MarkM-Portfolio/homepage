...
public class FVT_Discover_Priv_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory("A "+PrivateWikiCommunity+" community wiki was created.","Discover","Wikis", false);
		...
		public void testCreateANewWikiPage_PrivateComm () throws Exception {
			...
			verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Discover","Wikis", false);
		...
		public void testRecommendAWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Discover","Wikis", false);
		...
		public void testAddCommentToWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","Discover","Wikis", false);
