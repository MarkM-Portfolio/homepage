...
public class FVT_ImFollowing_People_Mod_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);
	...
	public void testForumUpdated_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" updated the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);
	...
	public void testForumTopicCreated_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" created a topic named "+ModeratedCommTopic+" in the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);	
	...
	public void testForumTopicReply_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters("commented on the Re: "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);
	...
	public void testForumTopicUpdated_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" updated the "+ModeratedCommTopic+" topic in the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);
	...
	public void testForumTopicReplyUpdated_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(" updated the "+ModeratedCommTopic+" topic thread in the "+ModeratedCommForum+" forum.","I'm Following","Communities","People","Forums", true);
