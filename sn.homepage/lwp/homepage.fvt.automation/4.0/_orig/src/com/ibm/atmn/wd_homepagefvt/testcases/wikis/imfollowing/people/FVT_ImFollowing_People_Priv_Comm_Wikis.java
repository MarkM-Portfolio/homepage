...
public class FVT_ImFollowing_People_Priv_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters("A "+PrivateWikiCommunity+" community wiki was created.","I'm Following","Communities","People","Wikis", true);
		...
		public void testCreateANewWikiPage_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", false);
		...
		public void testEditAWikiPage_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddATagToWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", false);
		...
		public void testRecommendAWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddCommentToWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" commented on the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditCommentWiki_PrivateComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters("updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Priv_Comm_Wiki+" in the "+PrivateWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
