...
public class FVT_Discover_Public_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testCreateIdeablog_PublicComm() throws Exception {
		...
		verifyNewsStory(" created an Ideation Blog named "+PublicIdeablogCommunity+".","Discover","Blogs", true);
	...
	public void testCreateIdea_PublicComm() throws Exception {
		...
		verifyNewsStory(" created the "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Discover","Blogs", true);
	...
	public void testAddCommentToIdea_PublicComm() throws Exception {
		...
		verifyNewsStory("commented on their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Discover","Blogs", true);
	...
	public void testCreateATrackbackToIdea_PublicComm() throws Exception {
		...
		verifyNewsStory("left a trackback on their own RE: "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Discover","Blogs", true);
	...
	public void testIdeaVoted_PublicComm() throws Exception {
		...
		verifyNewsStory(" voted for the "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Discover","Blogs", true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyNewsStory("liked their own comment on "+PublicIdeablogEntry+".","Discover","Blogs", true);
	...
	public void testIdeaGraduated_PublicComm() throws Exception {
		...
		verifyNewsStory("graduated their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Discover","Blogs", true);
