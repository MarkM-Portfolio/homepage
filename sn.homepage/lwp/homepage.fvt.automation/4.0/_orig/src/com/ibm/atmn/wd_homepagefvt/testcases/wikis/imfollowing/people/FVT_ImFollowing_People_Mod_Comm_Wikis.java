...
public class FVT_ImFollowing_People_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
		...
		public void testEditCommentWiki_ModeratedComm () throws Exception {
			...
			verifyNewsStory_ThreeFilters("updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","I'm Following","Communities","People","Wikis", true);
