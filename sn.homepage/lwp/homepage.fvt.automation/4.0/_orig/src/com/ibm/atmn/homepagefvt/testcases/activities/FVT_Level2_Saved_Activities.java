...
public class FVT_Level2_Saved_Activities extends FVT_ActivitiesMethods {
	...
	@Test 
	public void testMarkingActivityStoriesAsSaved() throws Exception {
			
			
			System.out.println("INFO: Start of Activities FVT_Level_2 testMarkingActivityStoriesAsSaved");
			...
			System.out.println("INFO: End of Activities FVT_Level_2 testMarkingActivityStoriesAsSaved");
			
		}
	
	@Test (dependsOnMethods = { "testMarkingActivityStoriesAsSaved" })
	public void testMarkingActivityStoriesAsSavedPart2() throws Exception {
		
		
		System.out.println("INFO: Start of Activities FVT_Level_2 testMarkingActivityStoriesAsSavedPart2");
		...
		System.out.println("INFO: End of Activities FVT_Level_2 testMarkingActivityStoriesAsSavedPart2");
		
	}
	
	@Test (dependsOnMethods = { "testMarkingActivityStoriesAsSavedPart2" })
