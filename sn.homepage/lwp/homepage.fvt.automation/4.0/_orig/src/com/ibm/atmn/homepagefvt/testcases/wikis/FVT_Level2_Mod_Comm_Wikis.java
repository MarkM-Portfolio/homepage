...
public class FVT_Level2_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_ModeratedComm () throws Exception {
			...
			VerifyNewsStory("A new "+ModeratedWikiCommunity+" community wiki was created.","Discover","Wikis", true);
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			VerifyNewsStory(" created a new wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			sel.type(WikisObjects.Page_Name_Textfield_In_Editor, FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki);
			...
			Assert.assertTrue("FAIL: Changed page title isn't correct", sel.getText(WikisObjects.WikiHomePageTitleField).equals(FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki));
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			VerifyNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		  	
			System.out.println("INFO: End of testAddATagToWiki_ModeratedComm");
		}
		
		@Test (dependsOnMethods = { "testAddATagToWiki_ModeratedComm" })
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			VerifyNewsStory(" recommended the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
		  	
			System.out.println("INFO: End of testRecommendAWiki_ModeratedComm");
		}
		
		@Test (dependsOnMethods = { "testRecommendAWiki_ModeratedComm" })
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			VerifyNewsStory(" commented on the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Discover","Wikis", true);
