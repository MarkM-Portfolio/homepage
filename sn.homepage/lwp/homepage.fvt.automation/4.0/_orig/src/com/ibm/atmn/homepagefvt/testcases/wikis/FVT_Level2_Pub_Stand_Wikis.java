...
public class FVT_Level2_Pub_Stand_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewPublicWiki () throws Exception {
			...
			//
			VerifyNewsStory(" created a new wiki named "+FVT_WikisData.CI_Box_Public_Wiki+".","Discover","Wikis", true);
		...
		public void testAddPagesToPublicWiki () throws Exception {
			...
			//
			VerifyNewsStory(" created a new wiki page named "+FVT_WikisData.New_Peer_Page_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		public void testEditPageInPublicWiki () throws Exception {
			...
			VerifyNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Public_Wiki2+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		@Test (dependsOnMethods = { "testEditPageInPublicWiki" })
		public void testAddATagToPublicWiki() throws Exception {
			...
			VerifyNewsStory(" tagged the wiki page Welcome with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		@Test (dependsOnMethods = { "testAddATagToPublicWiki" })
		public void testRecommendAPageForPublicWiki () throws Exception {
			...
			VerifyNewsStory(" recommended the wiki page Welcome in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		@Test (dependsOnMethods = { "testRecommendAPageForPublicWiki" })
		public void testAddCommentToPublicWiki () throws Exception {
			...
			VerifyNewsStory(" commented on the wiki page Re: Welcome in the "+FVT_WikisData.CI_Box_Public_Wiki+" wiki.","Discover","Wikis", true);
		...
		@Test (dependsOnMethods = { "testAddCommentToPublicWiki" }, groups = "broken")
		...
		@Test (dependsOnMethods = { "testDeletePage" }, groups = "broken")
		public void testDeletePublicWiki () throws Exception {
			...
			//Enter creators username & password
			Login(CommonData.IC_LDAP_Username450, CommonData.IC_LDAP_Username450);			
			...
			Assert.assertTrue("FAIL: Wiki still exists", !verifyWikiExists(FVT_WikisData.CI_Box_Public_Wiki2, "Public"));
