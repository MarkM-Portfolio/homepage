...
public class FVT_ImFollowing_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		verifyNewsStory(" edited the wiki page "+FVT_WikisData.New_Child_Page_For_Private_Wiki2+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		verifyNewsStory(" tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		verifyNewsStory(" liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		verifyNewsStory(" commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
	...
	public void testEditCommentPrivateWiki () throws Exception {
		...
		verifyNewsStory("updated the comment on the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis", true);
