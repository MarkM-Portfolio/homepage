...
public class FVT_ActionRequired_00012 extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity() throws Exception {
			...
			PublicActivityName = startAnActivity(FVT_ActivitiesData.Start_Public_Activity_InputText_Name_Data+genDateBasedRandVal(),typist,CommonData.IC_LDAP_Username_Fullname451);
	...
	public void testCreateStandPublicActivity_AssignedToDo() throws Exception {
		...
		// Create a new to do
		PublicAssignedToDoName = addToDoToActivity(PublicActivityName+" Assigned To-Do",typist, false, true, CommonData.IC_LDAP_Username_Fullname451);
	...
	public void testCreateStandPrivateActivity() throws Exception {
			...
			PrivateActivityName = startAnActivity(FVT_ActivitiesData.Start_Private_Activity_InputText_Name_Data+genDateBasedRandVal(),typist,CommonData.IC_LDAP_Username_Fullname451);
	...
	public void testCreateStandPrivateActivity_AssignedToDo() throws Exception {
		
		
		
		System.out.println("INFO: Start of Activities FVT_Level_2 testCreateStandPrivateActivity_AssignedToDo");
		...
		// Create a new to do
		PrivateAssignedToDoName = addToDoToActivity(PrivateActivityName+" Assigned To-Do",typist, false, true, CommonData.IC_LDAP_Username_Fullname451);
			
		//Logout
		Logout();
			
		System.out.println("INFO: End of Activities FVT_Level_2 testCreateStandPrivateActivity_AssignedToDo");
			
	}
	
	@Test (dependsOnMethods = { "testCreateStandPublicActivity_AssignedToDo","testCreateStandPrivateActivity_AssignedToDo" })
	public void testVerifyBadgeIsPresent() throws Exception {
			...
			String ActionRequiredStory = "css=div.lotusPostContent:contains('assigned you a to-do item named "+PrivateAssignedToDoName+" in the "+PrivateActivityName+" activity.')";
			...
			assertTrue("FAIL: Number of stories not equal to '1'", driver.getSingleElement(FVT_NewsObjects.ActionRequiredBadge).getText().compareToIgnoreCase("1") == 0);
