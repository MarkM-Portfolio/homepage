...
package com.ibm.atmn.lc.appobjects.profiles;

public class ProfilesObjects {

	//Board
	public static final String ProfilesBoard = "css=#wallEntryFormInputMsg";
	public static final String PostStatus = "css=input[id='wallEntryFormSubmit']";
	...
	public static final String ProfilesTagForBVT = "link=";
