...
public class FVT_Level2_ModCommunities extends FVT_CommunitiesMethods{
	/*
	...
	public void testCreateModComm() throws Exception {
		...
		VerifyNewsStory(" created a new community named "+ModeratedCommunity+".","Discover","Communities", true);
