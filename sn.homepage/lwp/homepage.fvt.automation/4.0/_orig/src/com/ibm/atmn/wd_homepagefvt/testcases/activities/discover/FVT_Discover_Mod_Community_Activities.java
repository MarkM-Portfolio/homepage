...
public class FVT_Discover_Mod_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_ModComm() throws Exception {
		...
		verifyNewsStory(" created an activity named "+ModeratedCommunityActivity+".","Discover","Activities", true);
	...
	public void testCreateActivityEntry_ModComm() throws Exception {
		...
		verifyNewsStory(" created the "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Discover","Activities", true);
	...
	public void testCreateActivityComment_ModComm() throws Exception {
		...
		verifyNewsStory("commented on their own "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","Discover","Activities", true);
	...
	public void testCreateActivityToDo_ModComm() throws Exception {
		...
		verifyNewsStory(" created a to-do item named "+ModActivityToDo+" in the "+ModeratedCommunityActivity+" activity.","Discover","Activities", true);
	...
	public void testMarkToDoAsCompleted_ModComm() throws Exception {
		...
		verifyNewsStory("completed their own "+ModActivityToDo+" to-do item in the "+ModeratedCommunityActivity+" activity.","Discover","Activities", true);
