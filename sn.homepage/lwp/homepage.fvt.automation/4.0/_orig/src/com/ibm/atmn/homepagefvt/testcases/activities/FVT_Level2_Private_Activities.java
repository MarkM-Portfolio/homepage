...
public class FVT_Level2_Private_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPrivateActivity() throws Exception {
		...
		privateActivityName = startAnActivity(FVT_ActivitiesData.Start_Private_Activity_InputText_Name_Data+genDateBasedRandVal(),typist,CommonData.IC_LDAP_Username451);
		...
		VerifyNewsStory(" created a new activity named "+privateActivityName+".","Discover","Activities", false);
	...
	public void testCreateStandPrivateActivity_PrivateEntry() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		VerifyNewsStory(" created the "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","Discover","Activities", false);
	...
	public void testCreateStandPrivateActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		VerifyNewsStory(" commented on their own "+privateEntryTitle+" entry in the "+privateActivityName+" activity.","Discover","Activities", false);
	...
	public void testCreateStandPrivateActivity_ToDo() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		VerifyNewsStory(" created a to-do named "+privateToDoName+" in the "+privateActivityName+" activity.","Discover","Activities", false);
	...
	public void testMarkToDoAsCompleted_PrivateActivity() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		VerifyNewsStory(" completed their own "+privateToDoName+" to-do item in the "+privateActivityName+" activity.","Discover","Activities", false);
	...
	public void testChangeActivityToPublicAccess() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		VerifyNewsStory(" created a public activity named "+privateActivityName+".","Discover","Activities", true);
