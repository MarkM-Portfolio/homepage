...
public class FVT_ImFollowing_Misc_Comm_Blogs extends FVT_BlogsMethods{
	...
	*/
	...
	public void testCreateBlogEntry_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a blog entry named "+PublicBlogEntry+" in the "+PublicBlogCommunity+" blog.","Blogs", true);
	...
	public void testChangeAccess_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a blog entry named "+PublicBlogEntry2+" in the "+PublicBlogCommunity+" blog.","Blogs", false);
