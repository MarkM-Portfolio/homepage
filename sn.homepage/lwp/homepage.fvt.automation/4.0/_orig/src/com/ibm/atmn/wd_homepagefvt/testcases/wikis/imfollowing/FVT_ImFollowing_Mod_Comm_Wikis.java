...
public class FVT_ImFollowing_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(" edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditCommentWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory("updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
