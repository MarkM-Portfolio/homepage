...
public class FVT_ImFollowing_Tags_ModCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateFeed_ModComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" added the "+ModeratedCommFeed+" feed to the "+ModeratedCommunity+" community.","Communities","automation",false, true);
	...
	public void testAddBookmark_ModComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" added the "+ModeratedCommBookmark+" bookmark to the "+ModeratedCommunity+" community.","Communities","automation",false, true);
	...
	public void testUpdateBookmark_ModComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" updated the "+ModeratedCommBookmark+" bookmark in the "+ModeratedCommunity+" community.","Communities","automation",false, true);
