...
public class FilesObjects {
	...
	public static final String UploadFiles_Button = "//button[@class='lotusBtn' and @title='Upload files from your computer']";
	...
	public static final String Rename_Link = "css=li.lotusFirst a.lotusAction li:nth-child(2)";
	public static final String Replace_Link = "css=li.lotusFirst a.lotusAction";//"link=Replace"; 
	...
	public static final String ProgressBar = "css=div.lotusRight div#dijit_ProgressBar_1.dijitProgressBar";
	...
	//FF-only
	public static final String Browse_Button = "css=span.lconnUploadContainer button.lotusBtn:contains('Browse...')";
	...
	public static String FileMovedToTrashMessage = "css=div.lotusMessage span";// span
