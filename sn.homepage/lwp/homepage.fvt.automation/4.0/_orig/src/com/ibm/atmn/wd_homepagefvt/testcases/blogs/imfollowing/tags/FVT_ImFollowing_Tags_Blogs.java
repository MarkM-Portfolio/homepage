...
public class FVT_ImFollowing_Tags_Blogs extends FVT_BlogsMethods{
	...
	public void testCreateStandAloneBlog() throws Exception{
		...
		verifyImFollowingTagsNewsStory(" created a blog named "+StandaloneBlogName+".","Blogs","automation", false, true);
	...
	public void testCreateStandAloneBlogEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory(" created a blog entry named "+StandaloneBlogEntry+" in the "+StandaloneBlogName+" blog.","Blogs","automation",false, true);
	...
	public void testUpdateBlogSettings() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory(" updated the "+StandaloneBlogName+" blog.","Blogs","automation",false, true);
	...
	public void testUpdateStandAloneBlogEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory(" updated the "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.","Blogs","automation", false, true);
	...
	public void testAddCommentStandaloneEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory("commented on their own "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.","Blogs","automation",false, true);
	...
	public void testCreateATrackbackToStandaloneEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory("left a trackback on their own "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.", "Blogs", "automation", false, true);
	...
	public void testRecommendStandaloneEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory("liked their own "+StandaloneBlogEntry+" blog entry in the "+StandaloneBlogName+" blog.","Blogs", "automation", false, true);
	...
	public void testRecommendCommentStandaloneEntry() throws Exception{
		...
		//
		verifyImFollowingTagsNewsStory("liked their own comment on "+StandaloneBlogEntry+".","Discover", "automation", false, true);
