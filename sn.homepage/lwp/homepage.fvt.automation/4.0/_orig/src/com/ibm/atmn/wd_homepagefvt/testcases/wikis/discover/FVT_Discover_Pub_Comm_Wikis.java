...
public class FVT_Discover_Pub_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testCreateANewWiki_PublicComm () throws Exception {
			...
			verifyNewsStory("A "+PublicWikiCommunity+" community wiki was created.","Discover","Wikis", true);
		...
		public void testCreateANewWikiPage_PublicComm () throws Exception {
			...
			verifyNewsStory(" created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testAddATagToWiki_PublicComm () throws Exception {
			...
			verifyNewsStory(" tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+PublicWikiCommunity+" wiki.","Discover","Wikis", false);
		...
		public void testRecommendAWiki_PublicComm () throws Exception {
			...
			verifyNewsStory(" liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Discover","Wikis", true);
		...
		public void testAddCommentToWiki_PublicComm () throws Exception {
			...
			verifyNewsStory(" commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Pub_Comm_Wiki+" in the "+PublicWikiCommunity+" wiki.","Discover","Wikis", true);
