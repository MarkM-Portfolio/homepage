...
public class FVT_Discover_Mod_Comm_Blogs extends FVT_BlogsMethods{
	/*
	...
	public void testCreateBlog_ModComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMM_BLOG, ModeratedBlogCommunity, null, CommonData.IC_LDAP_Username_Fullname450);
		...
		//
		//verifyNewsStory(" created a blog named "+ModeratedBlogCommunity+".","Discover","Blogs", true);
	...
	public void testCreateBlogEntry_ModComm() throws Exception {
		...
		//
		//verifyNewsStory(" created a blog entry named "+ModeratedBlogEntry+" in the "+ModeratedBlogCommunity+" blog.","Discover","Blogs", true);
	...
	public void testRecommendEntry_ModComm() throws Exception {
		...
		//
		//verifyNewsStory("liked their own "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Discover","Blogs", true);
	...
	public void testRecommendComment_ModComm() throws Exception {
		...
		//
		//verifyNewsStory("liked their own comment on "+ModeratedBlogEntry+".","Discover","Blogs", true);
