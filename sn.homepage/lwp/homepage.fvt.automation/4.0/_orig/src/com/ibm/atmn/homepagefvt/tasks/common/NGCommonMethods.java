...
public abstract class NGCommonMethods extends PageActionMethods {
	...
	public void Login(String User_Name, String Password) {
		...
		for (int second = 0;; second++) {
			if (second >= 200)
				AssertJUnit.fail("Username field has not appeared after 120 seconds");
			try {
