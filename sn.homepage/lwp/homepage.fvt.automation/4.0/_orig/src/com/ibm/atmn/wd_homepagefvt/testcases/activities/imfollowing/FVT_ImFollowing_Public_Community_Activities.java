...
public class FVT_ImFollowing_Public_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivityEntry_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created the "+PublicActivityEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityPrivateEntry_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created the "+PublicActivityPrivateEntry+" entry in the "+PublicCommunityActivity+" activity.","Activities", false);
	...
	public void testCreateActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory("commented on the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","Activities", true);
	...
	public void testEditActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory("updated the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityPrivateComment_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory("commented on the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","Activities", false);
	...
	public void testCreateActivityToDo_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a to-do item named "+PublicActivityToDo+" in the "+PublicCommunityActivity+" activity.","Activities", true);
	...
	public void testMarkToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory("completed their own "+PublicActivityToDo+" to-do item in the "+PublicCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityPrivateToDo_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a to-do item named "+PublicActivityPrivateToDo+" in the "+PublicCommunityActivity+" activity.","Activities", false);
	...
	public void testMarkPrivateToDoAsCompleted_PublicComm() throws Exception {
		...
		verifyImFollowingNewsStory("completed their own "+PublicActivityPrivateToDo+" to-do item in the "+PublicCommunityActivity+" activity.","Activities", false);
