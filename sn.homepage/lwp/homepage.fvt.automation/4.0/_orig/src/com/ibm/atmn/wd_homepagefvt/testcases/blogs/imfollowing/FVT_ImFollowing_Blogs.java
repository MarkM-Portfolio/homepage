...
public class FVT_ImFollowing_Blogs extends FVT_BlogsMethods{
	...
	public void testFollowPublicBlog() throws Exception {
			...
			verifyNewsStory(" created a blog named "+StandaloneBlogName+".","I'm Following","Blogs", false);
	...
	public void testCreateStandAloneBlogEntry() throws Exception{
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_BLOG_ENTRY, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.BLOGS, true);
	...
	public void testCreateStandAloneBlogEntry_Draft() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_DRAFT_BLOG_ENTRY, StandaloneBlogEntryDraft, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.BLOGS, false);
	...
	public void testUpdateStandAloneBlogEntry() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BLOG_ENTRY, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testAddCommentStandaloneEntry() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_COMMENT_BLOG_ENTRY, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, true);
	...
	public void testCreateATrackbackToStandaloneEntry() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.ADD_TB_BLOG_ENTRY, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testRecommendStandaloneEntry() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_ENTRY, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
	...
	public void testRecommendCommentStandaloneEntry() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.LIKE_BLOG_COMMENT, StandaloneBlogEntry, StandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(CommonData.IC_LDAP_Username451, CommonData.IC_LDAP_Password451, BlogNewsStory,FVT_NewsData.IM_FOLLOWING_VIEW,FVT_NewsData.BLOGS, true);
	  	
		//
		//verifyNewsStory("liked their own comment on "+StandaloneBlogEntry+".","Discover","I'm Following", true);
	...
	public void testBlogParentItemRename() throws Exception{
		...
		//Replace news story string
		String BlogNewsStory = replaceNewsStory(NewsStoryData.UPDATE_BLOG_ENTRY, StandaloneBlogEntry, EditedStandaloneBlogName, CommonData.IC_LDAP_Username_Fullname450);
