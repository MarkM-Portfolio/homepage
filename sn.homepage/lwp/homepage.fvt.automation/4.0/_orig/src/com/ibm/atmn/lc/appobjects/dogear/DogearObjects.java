...
package com.ibm.atmn.lc.appobjects.dogear;

import com.ibm.atmn.lc.appobjects.common.CommonObjects;

public class DogearObjects extends CommonObjects {

	//Add bookmark
	public static String Nav_AddBookmark = "css=a:contains('Add a Bookmark')";
	...
	public static String Nav_HowToBookmark = "css=a:contains('Bookmark or Discuss This')";

	//Bookmarket: Button page and extra bottom tabs not present on add bookmark form
	public static String Bookmarklet_Bookmarklet1 = "css=a[title='Add Bookmark']";
	public static String Bookmarklet_Bookmarklet2 = "css=a[title='Discuss This']";
