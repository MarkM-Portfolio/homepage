...
public class FVT_ImFollowing_Private_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivityEntry_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityComment_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory("commented on the "+PrivateActivityEntry+" entry thread in the "+PrivateCommunityActivity+" activity.","Activities", true);
	...
	public void testEditActivityComment_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory(" updated the "+PrivateActivityEntry+" entry thread in the "+PrivateCommunityActivity+" activity.","Activities", true);
	...
	public void testCreateActivityToDo_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory(" created a to-do item named "+PrivateActivityToDo+" in the "+PrivateCommunityActivity+" activity.","Activities", true);
	...
	public void testMarkToDoAsCompleted_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory("completed their own "+PrivateActivityToDo+" to-do item in the "+PrivateCommunityActivity+" activity.","Activities", true);
