...
public class FVT_ImFollowing_Tags_Private_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_PrivateComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created the "+PrivateCommForum+" forum.","Forums","automation", true, false);
	...
	public void testForumUpdated_PrivateComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(" updated the "+PrivateCommForum+" forum.","Forums","automation", true, false);
	...
	public void testForumTopicCreated_PrivateComm() throws Exception {
		...
		//Verify news story does not appear in AS->Discover
		verifyImFollowingTagsNewsStory(" created a topic named "+PrivateCommTopic+" in the "+PrivateCommForum+" forum.","Forums","automation", true, false);	
	...
	public void testForumTopicReply_PrivateComm() throws Exception {
		...
		//Verify news story does not appear in AS->Discover
		verifyImFollowingTagsNewsStory("replied to their own Re: "+PrivateCommTopic+" topic in the "+PrivateCommForum+" forum.","Forums","automation", true, false);	
	...
	public void testForumTopicUpdated_PrivateComm() throws Exception {
		...
		//Verify news story does not appear in AS->Discover
		verifyImFollowingTagsNewsStory(" updated the "+PrivateCommTopic+" topic in the "+PrivateCommForum+" forum:","Forums","automation", true, false);	
