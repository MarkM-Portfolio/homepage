...
public class FVT_ImFollowing_People_Forums extends FVT_ForumsMethods {
	...
	public void testCreateStandaloneForum() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
	...
	public void testUpdateStandaloneForum() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," updated the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
	...
	public void testCreateStandaloneForumTopic() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created a topic named "+part1TopicTitle+" in the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
	...
	public void teststandaloneForumReply() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS,"commented on the Re: "+part1TopicTitle+" topic thread in the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
	...
	public void testUpdateStandaloneForumTopic() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," updated the "+part1TopicTitle+" topic in the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
	...
	public void testUpdateStandaloneForumTopicReply() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," updated the "+part1TopicTitle+" topic thread in the "+part1ForumName+" forum.","I'm Following","Forums","People", true);
