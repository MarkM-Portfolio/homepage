...
public class FVT_ImFollowing_People_Private_Stand_Wikis extends FVT_WikisMethods{
	...
	public void testCreateANewPrivateWiki () throws Exception {
		...
		//
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created a wiki named "+FVT_WikisData.CI_Box_Private_Wiki+".","I'm Following","Wikis","People", false);
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		//VerifyAddedContentInHomepage(FVT_WikisData.New_Content_For_Private_Wiki);
	  	...
	  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," edited the wiki page "+FVT_WikisData.New_Child_Page_For_Private_Wiki2+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		Assert.assertTrue("FAIL: Tag hasn't been added correctly", driver.isTextPresent(FVT_WikisData.Tag_For_Private_Wiki));
	  	...
	  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		LikeCurrentPage();
	  	...
	  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		VerifyCommentIsAdded(FVT_WikisData.Comment_For_Private_Wiki);
	  	...
	  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testEditCommentPrivateWiki () throws Exception {
		...
		VerifyCommentIsAdded(FVT_WikisData.Comment_For_Private_Wiki);
	  	...
	  	verifyNewsStory_TwoFilters(USER_2, USER_2_PASS,"updated the comment on the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
