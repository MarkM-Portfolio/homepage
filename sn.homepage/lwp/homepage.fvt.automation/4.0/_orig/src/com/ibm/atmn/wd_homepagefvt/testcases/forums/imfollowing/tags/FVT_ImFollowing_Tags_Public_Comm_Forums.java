...
public class FVT_ImFollowing_Tags_Public_Comm_Forums extends FVT_ForumsMethods {
	...
	public void testForumCreated_PublicComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" created the "+PublicCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumUpdated_PublicComm() throws Exception {
			...
			verifyImFollowingTagsNewsStory(" updated the "+PublicCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumTopicCreated_PublicComm() throws Exception {
			...
			//Verify news story appears in AS->Discover
			verifyImFollowingTagsNewsStory(" created a topic named "+PublicCommTopic+" in the "+PublicCommForum+" forum.","Forums","automation", true, true);
	...
	public void testForumTopicReply_PublicComm() throws Exception {
			...
			//Verify news story appears in AS->Discover
			verifyImFollowingTagsNewsStory("replied to their own Re: "+PublicCommTopic+" topic in the "+PublicCommForum+" forum.","Forums","automation", true, true);	
	...
	public void testForumTopicUpdated_PublicComm() throws Exception {
			...
			//Verify news story appears in AS->Discover
			verifyImFollowingTagsNewsStory(" updated the "+PublicCommTopic+" topic in the "+PublicCommForum+" forum.","Forums","automation", true, true);	
