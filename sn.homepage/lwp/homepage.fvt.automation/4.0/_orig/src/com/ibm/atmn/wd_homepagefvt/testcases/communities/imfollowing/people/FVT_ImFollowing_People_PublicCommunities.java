...
public class FVT_ImFollowing_People_PublicCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateFeed_PublicComm() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," added the "+PublicCommFeed+" feed to the "+PublicCommunity+" community.","I'm Following","Communities","People", true);
	...
	public void testAddBookmark_PublicComm() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," added the "+PublicCommBookmark+" bookmark to the "+PublicCommunity+" community.","I'm Following","Communities","People", true);
	...
	public void testUpdateBookmark_PublicComm() throws Exception {
		...
		verifyNewsStory_TwoFilters(USER_2, USER_2_PASS," updated the "+PublicCommBookmark+" bookmark in the "+PublicCommunity+" community.","I'm Following","Communities","People", true);
