...
public class FVT_ImFollowing_Mod_Comm_Wikis extends FVT_WikisMethods{
		...
		public void testFollowPublicCommunity() throws Exception {
			...
			assertTrue("Text not present!",driver.isTextPresent("A "+ModeratedWikiCommunity+" community wiki was created."));
		...
		public void testCreateANewWikiPage_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2, " created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditAWikiPage_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2, " edited the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddATagToWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2," tagged the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" with "+FVT_WikisData.Tag_For_Public_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", false);
		...
		public void testRecommendAWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2, " liked the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testAddCommentToWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2, " commented on the wiki page "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
		...
		public void testEditCommentWiki_ModeratedComm () throws Exception {
			...
			verifyImFollowingNewsStory(testUser2, "updated the wiki page Re: "+FVT_WikisData.New_Peer_Page_For_Edited_Mod_Comm_Wiki+" in the "+ModeratedWikiCommunity+" wiki.","Wikis", true);
