...
public class FVT_ImFollowing_People_Private_Stand_Wikis extends FVT_WikisMethods{
...
@Test (dependsOnMethods = { "testLoginUsers" })
	...
	public void testCreateANewPrivateWiki () throws Exception {
		...
		createPrivateWikiWithUsers(FVT_WikisData.CI_Box_Private_Wiki,testUser1.getEmail());
		...
		//
		verifyNewsStory_TwoFilters(testUser2," created a wiki named "+FVT_WikisData.CI_Box_Private_Wiki+".","I'm Following","Wikis","People", false);
	...
	public void testAddPagesToPrivateWiki () throws Exception {
		...
		verifyNewsStory_TwoFilters(testUser2," created a wiki page named "+FVT_WikisData.New_Peer_Page_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testEditPageInPrivateWiki () throws Exception {
		...
		//Logout of Wiki
	  	...
	  	verifyNewsStory_TwoFilters(testUser2," updated the wiki page "+FVT_WikisData.New_Child_Page_For_Private_Wiki2+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testAddATagToPrivateWiki() throws Exception {
		...
		//Logout of Wiki
	  	...
	  	verifyNewsStory_TwoFilters(testUser2," tagged the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" with "+FVT_WikisData.Tag_For_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testRecommendAPageOfPrivateWiki () throws Exception {
		...
		//Logout of Wiki
	  	...
	  	verifyNewsStory_TwoFilters(testUser2," liked the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testAddCommentToPrivateWiki () throws Exception {
		...
		//Logout of Wiki
	  	...
	  	verifyNewsStory_TwoFilters(testUser2," commented on the wiki page Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
	...
	public void testEditCommentPrivateWiki () throws Exception {
		...
		//Logout of Wiki
	  	...
	  	verifyNewsStory_TwoFilters(testUser2,"updated the comment on the wiki page Re: Welcome to "+FVT_WikisData.CI_Box_Private_Wiki+" in the "+FVT_WikisData.CI_Box_Private_Wiki+" wiki.","I'm Following","Wikis","People", false);
