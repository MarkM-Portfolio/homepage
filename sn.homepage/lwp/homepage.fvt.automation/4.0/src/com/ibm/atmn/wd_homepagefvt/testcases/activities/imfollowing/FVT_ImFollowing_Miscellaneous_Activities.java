...
public class FVT_ImFollowing_Miscellaneous_Activities extends FVT_ActivitiesMethods {
	...
	public void testUnfollowFromNewsFeed() throws Exception {
			...
			assertTrue("Stop Following link still there!", !driver.isElementPresent(FVT_HomepageObjects.StopFollowing));
	...
	public void testCreateStandPublicActivity_SecondPublicEntry() throws Exception {
		...
		// Create a new entry within this activity
		publicActivityPublicEntryTitle2 = addEntryToActivity_Basic(publicActivityName+" Entry",typist, false);
	...
	public void testVerifyNoActivityStoryInNF() throws Exception {
			...
			assertTrue("Activities entry story not appearing in Im Following View.", !driver.isTextPresent(" created the "+publicActivityPublicEntryTitle2+" entry in the "+publicActivityName+" activity."));
