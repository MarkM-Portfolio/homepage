...
public class FVT_ImFollowing_People_Private_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created an activity named "+PrivateCommunityActivity+".","I'm Following","Communities","People","Activities", false);
	...
	public void testCreateActivityEntry_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testCreateActivityComment_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"commented on their own "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testEditActivityComment_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," updated the comment on the "+PrivateActivityEntry+" entry in the "+PrivateCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testCreateActivityToDo_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created a to-do item named "+PrivateActivityToDo+" in the "+PrivateCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
	...
	public void testMarkToDoAsCompleted_PrivateComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"completed their own "+PrivateActivityToDo+" to-do item in the "+PrivateCommunityActivity+" activity.","I'm Following","Communities","People","Activities", false);
