...
public class FVT_ImFollowing_People_Mod_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivity_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created an activity named "+ModeratedCommunityActivity+".","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityEntry_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created the "+ModeratedActivityEntry+" entry in the "+ModeratedCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityComment_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"commented on the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testEditActivityComment_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"updated the "+ModeratedActivityEntry+" entry thread in the "+ModeratedCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testCreateActivityToDo_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2," created a to-do item named "+ModActivityToDo+" in the "+ModeratedCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
	...
	public void testMarkToDoAsCompleted_ModComm() throws Exception {
		...
		verifyNewsStory_ThreeFilters(testUser2,"completed their own "+ModActivityToDo+" to-do item in the "+ModeratedCommunityActivity+" activity.","I'm Following","Communities","People","Activities", true);
