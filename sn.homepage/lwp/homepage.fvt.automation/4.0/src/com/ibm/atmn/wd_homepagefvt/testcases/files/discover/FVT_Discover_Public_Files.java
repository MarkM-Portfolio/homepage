...
public class FVT_Discover_Public_Files extends FVT_FilesMethods{
	...
	public void testVerifyPublicFileUpload () throws Exception {
		System.out.println("INFO: Start of Files FVT_Level_2 testVerifyPublicFileUpload");
		
		verifyNewsStory(" created the file "+PublicFile+".jpg.","Discover","Files", true);
	  	
		System.out.println("INFO: End of Files FVT_Level_2 testVerifyPublicFileUpload");
	}
