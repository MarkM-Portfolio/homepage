...
public class FVT_Saved_AllUpdates_Blogs extends FVT_BlogsMethods {
	...
	public void testMarkingBlogStoriesAsSaved_AllUpdates() throws Exception {
		...
		assertTrue("Fail: text is not present!!", driver.isTextPresent(" created a new blog named "+StandaloneBlogName+"."));
	...
	public void testMarkingBlogStoriesAsSavedPart2_AllUpdates() throws Exception {
		...
		assertTrue("Fail: text is not present!!", driver.isTextPresent("created a new blog entry named "+StandaloneBlogEntry+" in the "+StandaloneBlogName+" blog."));
