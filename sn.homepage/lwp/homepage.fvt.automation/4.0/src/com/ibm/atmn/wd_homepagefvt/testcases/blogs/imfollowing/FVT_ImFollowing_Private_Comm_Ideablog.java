...
public class FVT_ImFollowing_Private_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testFollowPrivateCommunityBlog() throws Exception {
			...
			assertTrue("Text not present!",driver.isTextPresent(" added an Ideation Blog to the "+PrivateIdeablogCommunity+" community."));
			
			filterBy("Blogs");
			
			Thread.sleep(2000);
			
			assertTrue("Text is present!",driver.isTextPresent(" added an Ideation Blog to the "+PrivateIdeablogCommunity+" community."));
	...
	public void testIdeaVoted_PrivateComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2," voted for the "+PrivateIdeablogEntry+" idea in the "+PrivateIdeablogCommunity+" Ideation Blog.","Blogs", true);
