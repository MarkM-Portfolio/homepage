...
public class FVT_BlogsMethods extends FVT_CommunitiesMethods {
	...
	public void notifyAboutBlogEntry(User Username) throws Exception {
		...
		driver.getSingleElement(FVT_BlogsObjects.NOTIFY_TYPEAHEAD).type(Username.getEmail());
	...
	public void assignUserRole(String Role, String User_Typeahead, String User_Fullname) throws Exception {
		...
		driver.getSingleElement(FVT_BlogsObjects.MEMBER_TYPEAHEAD_IDENTIFIER+":contains('"+User_Typeahead+"')").click();
