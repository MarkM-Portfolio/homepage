...
public class FVT_Discover_Community_Calendar_Public extends FVT_CommunitiesMethods{
	...
	public void testEventEntryUpdated_PublicComm() throws Exception {
		...
		//Open Community 
		openCommunity(PublicCommunity, FVT_CommunitiesObjects.ImAnOwner, FVT_CommunitiesObjects.LeftNavCalendar);
	...
	public void testEventCommentCreated_PublicComm() throws Exception {
		...
		//Open Community 
		openCommunity(PublicCommunity, FVT_CommunitiesObjects.ImAMember, FVT_CommunitiesObjects.LeftNavCalendar);
	...
	public void testSeriesEntryCreated_PublicComm() throws Exception {
		...
		RepeatingCalenderEvent = createCalendarEntry(PublicCommunity+" Repeating Calender Event" ,true,false, null);
