...
public class FVT_ImFollowing_Tags_Public_Community_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "commented on the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testEditActivityComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "updated the "+PublicActivityEntry+" entry thread in the "+PublicCommunityActivity+" activity.","Activities","automation", true, true);
	...
	public void testCreateActivityPrivateToDo_PublicComm() throws Exception {
		...
		// Create a new to do
		PublicActivityPrivateToDo = addToDoToActivity(PublicCommunityActivity +" to-Do",typist, true, false, testUser1);

		//Logout
		LogoutAndClose();
		
		verifyImFollowingTagsNewsStory(testUser2, " created a to-do item named "+PublicActivityPrivateToDo+" in the "+PublicCommunityActivity+" activity.","Activities","automation", true, false);
