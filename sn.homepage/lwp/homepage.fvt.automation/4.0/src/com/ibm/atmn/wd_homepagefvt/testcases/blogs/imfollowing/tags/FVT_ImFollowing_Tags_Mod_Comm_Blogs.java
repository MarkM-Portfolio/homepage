...
public class FVT_ImFollowing_Tags_Mod_Comm_Blogs extends FVT_BlogsMethods{
	...
	public void testAddCommentToBlog_ModComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "commented on their own "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendEntry_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory(testUser2, "liked their own "+ModeratedBlogEntry+" blog entry in the "+ModeratedBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_ModComm() throws Exception {
		...
		//
		verifyImFollowingTagsNewsStory(testUser2, "liked their own comment on "+ModeratedBlogEntry+".","Blogs","automation",true, true);
