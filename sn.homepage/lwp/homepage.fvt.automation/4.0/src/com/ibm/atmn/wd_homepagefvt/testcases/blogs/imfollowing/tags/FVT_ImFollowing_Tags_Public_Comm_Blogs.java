...
public class FVT_ImFollowing_Tags_Public_Comm_Blogs extends FVT_BlogsMethods{
	...
	public void testAddCommentToBlog_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "commented on their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendEntry_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "liked their own "+PublicBlogEntry+" blog entry in the "+PublicBlogCommunity+" blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2, "liked their own comment on "+PublicBlogEntry+".","Blogs","automation",true, true);
