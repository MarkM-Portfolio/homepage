...
public void testForumTopicUpdated_PublicComm() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_TOPIC, PublicCommTopic, PublicCommForum, null);
...
public void testForumTopicReplyUpdated_PublicComm() throws Exception {
		...
		//Replace news story string
		String ForumNewsStory = replaceNewsStory(NewsStoryData.UPDATE_REPLY, PublicCommTopic, PublicCommForum, null);
