...
public class FVT_Discover_ModCommunities extends FVT_CommunitiesMethods{
	...
	public void testCreateModComm() throws Exception {
		...
		verifyNewsStory(testUser2, " created a community named "+ModeratedCommunity+".","Discover","Communities", true);
	...
	public void testAddBookmark_ModComm() throws Exception {
			...
			verifyNewsStory(testUser2, " added the "+ModeratedCommBookmark+" bookmark to the "+ModeratedCommunity+" community.","Discover","Communities", true);
	...
	public void testCreateFeed_ModComm() throws Exception {
		...
		verifyNewsStory(testUser2, " added the "+ModeratedCommFeed+" feed to the "+ModeratedCommunity+" community.","Discover","Communities", true);
