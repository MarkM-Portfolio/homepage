...
public class FVT_ImFollowing_Mod_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testIdeaVoted_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2," voted for the "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs", true);
	...
	public void testIdeaGraduated_ModComm() throws Exception {
		...
		verifyImFollowingNewsStory(testUser2,"graduated their own "+ModeratedIdeablogEntry+" idea in the "+ModeratedIdeablogCommunity+" Ideation Blog.","Blogs", true);
