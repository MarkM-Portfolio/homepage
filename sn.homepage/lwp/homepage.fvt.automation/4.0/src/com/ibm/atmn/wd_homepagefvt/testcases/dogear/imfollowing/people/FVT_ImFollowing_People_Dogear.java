...
public class FVT_ImFollowing_People_Dogear extends FVT_DogearMethods {
	...
	public void testPublicBookmarkEdited() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyNewsStory_TwoFilters(testUser2," updated the bookmark named "+PUBLIC_BOOKMARK_NAME+".","I'm Following","Bookmarks","People", true);		
	...
	public void testAddTagToWatchlist() throws Exception {
		...
		// Verify story appears in AS -> Discover
		verifyNewsStory_TwoFilters(testUser2," added the following tag to their Bookmarks watchlist: fvttesttag","I'm Following","Bookmarks","People", false);		
