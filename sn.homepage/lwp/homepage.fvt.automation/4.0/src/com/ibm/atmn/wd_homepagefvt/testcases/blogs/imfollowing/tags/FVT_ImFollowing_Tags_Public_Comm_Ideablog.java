...
public class FVT_ImFollowing_Tags_Public_Comm_Ideablog extends FVT_BlogsMethods{
	...
	public void testAddCommentToIdea_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"commented on their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testCreateATrackbackToIdea_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"left a trackback on their own "+PublicIdeablogEntry+" idea in the "+PublicIdeablogCommunity+" Ideation Blog.","Blogs","automation",true, true);
	...
	public void testRecommendComment_PublicComm() throws Exception {
		...
		verifyImFollowingTagsNewsStory(testUser2,"liked their own comment on "+PublicIdeablogEntry+".","Blogs","automation",true, true);
