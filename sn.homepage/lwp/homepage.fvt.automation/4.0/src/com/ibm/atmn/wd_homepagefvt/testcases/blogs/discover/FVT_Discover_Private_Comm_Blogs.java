...
public class FVT_Discover_Private_Comm_Blogs extends FVT_BlogsMethods{
	...
	public void testCreateBlog_PrivateComm() throws Exception {
		...
		String BlogNewsStory = replaceNewsStory(NewsStoryData.CREATE_COMM_BLOG, PrivateBlogCommunity, null, testUser1.getDisplayName());
		
		//Verify that news story appears in  Activity Steam -> Discover;
		verifyNewsStory(testUser2, BlogNewsStory,FVT_NewsData.DISCOVER_VIEW,FVT_NewsData.BLOGS, false);
