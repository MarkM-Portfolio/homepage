...
public class FVT_ImFollowing_Tags_Public_Activities extends FVT_ActivitiesMethods {
	...
	public void testCreateStandPublicActivity_Comment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, "commented on the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","Activities","automation", false, true);
	...
	public void testCreateStandPublicActivity_EditComment() throws Exception {
		...
		//Verify that news story appears in  Activity Steam -> Discover
		verifyImFollowingTagsNewsStory(testUser2, " updated the "+publicActivityPublicEntryTitle+" entry thread in the "+publicActivityName+" activity.","Activities","automation", false, true);
