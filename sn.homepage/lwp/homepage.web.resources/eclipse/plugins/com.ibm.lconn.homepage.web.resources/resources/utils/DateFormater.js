...
dojo.provide("lconn.homepage.utils.DateFormater");
...
dojo.declare(
	// class
	"lconn.homepage.utils.DateFormater",	
	// superclass
	null,
	{	
		...
		formatDateTime: function(/*Date object or ISODateStamp string*/ date){
			...
			try{
				...
				hp_console_debug("formatDateTime exception [" + ex + "]");
				return ""; 
			}
		},
		...
		formatDate: function(/*Date object or ISODateStamp string*/ date){
			...
			try{
				...
				hp_console_debug("formatDate exception [" + ex + "]");
				return ""; 
			}
		},
		...
		formatTime: function(/*Date object or ISODateStamp string*/ date){
			...
			try{
				...
				hp_console_debug("formatTime exception [" + ex + "]");
				return ""; 
			}
		}
