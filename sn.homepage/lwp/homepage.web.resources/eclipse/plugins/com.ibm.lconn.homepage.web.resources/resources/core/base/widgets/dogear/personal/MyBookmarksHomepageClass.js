...
dojo.provide("lconn.homepage.core.base.widgets.dogear.personal.MyBookmarksHomepageClass");

dojo.require("lconn.homepage.core.base.baseDashboardIWidget");
dojo.require("lconn.homepage.widgets.bookmarks.BookmarkWidget");;

dojo.declare("lconn.homepage.core.base.widgets.dogear.personal.MyBookmarksHomepageClass", lconn.homepage.core.base.baseDashboardIWidget,{
	_dogearWidget: null,
	bundle: null,	
	
	onLoad: function(){	
		lconn.homepage.core.base.widgets.dogear.personal.MyBookmarksHomepageClass.superclass.onLoad.apply(this);
	},
	...
	onSaved: function(){
		lconn.homepage.core.base.widgets.dogear.personal.MyBookmarksHomepageClass.superclass.onSaved.apply(this);
