...
dojo.provide("lconn.homepage.core.base.widgets.communities.CommunitiesHomepageClass");
...
dojo.declare("lconn.homepage.core.base.widgets.communities.CommunitiesHomepageClass", lconn.homepage.core.base.baseDashboardIWidget,{
	_communitiesWidget: null,
	bundle: null,	
	
	onLoad: function(){	
		lconn.homepage.core.base.widgets.communities.CommunitiesHomepageClass.superclass.onLoad.apply(this);
	},
	...
	postOnLoad: function () {			
		...
		var feeds = 
		{
			...
			publicCountURL: this.getFeedUrl("publicCountURL")
		};
		...
		if (!this.loadPersistedMode())
			this._loadMode("MyCommunity");
			
	},
	
	loadMyCommunityMode:function() {
		this._communitiesWidget.MyCommunity(this.bundle.COMMUNITIES_MY_TITLE);
		this._currentModeFct = this.loadMyCommunityMode;
	},
	...
	onSaved: function(){
		lconn.homepage.core.base.widgets.communities.CommunitiesHomepageClass.superclass.onSaved.apply(this);
		var newView = this._communitiesWidget._getAmountOfEntriesToDisplay();
		//if more entries needed to load them
		if(this._communitiesWidget.entriesPerPage < newView) {
			this._communitiesWidget.entriesPerPage = newView;
			if (!this.loadPersistedMode()) {
				this._loadMode("MyCommunity"); 
			}
