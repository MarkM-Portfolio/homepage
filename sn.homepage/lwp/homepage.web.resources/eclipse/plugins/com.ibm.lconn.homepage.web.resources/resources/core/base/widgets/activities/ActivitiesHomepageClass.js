...
dojo.provide("lconn.homepage.core.base.widgets.activities.ActivitiesHomepageClass");
dojo.require("lconn.homepage.core.base.baseDashboardIWidget");

dojo.declare("lconn.homepage.core.base.widgets.activities.ActivitiesHomepageClass", lconn.homepage.core.base.baseDashboardIWidget,{	
	
	onLoad: function(){				
		lconn.homepage.core.base.widgets.activities.ActivitiesHomepageClass.superclass.onLoad.apply(this);
	},
	...
	loadNormalMode: function(keepfocus){		
	...
	loadPublicMode: function(keepfocus){
		this._destroyCurrentView();
	...
	onSaved: function(){
		lconn.homepage.core.base.widgets.activities.ActivitiesHomepageClass.superclass.onSaved.apply(this);
