...
dojo.provide("lconn.homepage.core.base.widgets.dogear.popular.PopularBookmarksHomepageClass");

dojo.require("lconn.homepage.core.base.baseDashboardIWidget");
dojo.require("lconn.homepage.widgets.bookmarks.BookmarkWidget");

dojo.declare("lconn.homepage.core.base.widgets.dogear.popular.PopularBookmarksHomepageClass", lconn.homepage.core.base.baseDashboardIWidget,{
	_dogearWidget: null,
	bundle: null,	
	
	onLoad: function(){			
		lconn.homepage.core.base.widgets.dogear.popular.PopularBookmarksHomepageClass.superclass.onLoad.apply(this);
	},
	...
	postOnLoad: function () {	
		...
		this._loadMode("PopularBookmarks");
	...
	onSaved: function(){
		lconn.homepage.core.base.widgets.dogear.popular.PopularBookmarksHomepageClass.superclass.onSaved.apply(this);
