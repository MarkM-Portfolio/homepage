...
dojo.provide("lconn.homepage.core.base.widgets.activitiesTodoList.ActivitiesTodoListHomepageClass");
dojo.require("lconn.homepage.core.base.baseDashboardIWidget");

dojo.declare("lconn.homepage.core.base.widgets.activitiesTodoList.ActivitiesTodoListHomepageClass", lconn.homepage.core.base.baseDashboardIWidget,{	
	
	onLoad: function(){		
		this._domID = "_" + this.iContext.widgetId + "_";	
		lconn.homepage.core.base.widgets.activitiesTodoList.ActivitiesTodoListHomepageClass.superclass.onLoad.apply(this);
		this.loadNormalMode();
	},
	...
	loadNormalMode: function(){		
		...
		dojo.require("lconn.homepage.widgets.activities.ActivitiesTodoList");				
		...
		{			    				 
			...
			todoUrl: this.getDefaultParam("todoUrl"),				 
			mappingRemoteUrl: this.getDefaultParam("mappingRemoteUrl")				
		};
		
		widget.parameters = params;
		
		var actualWidget = new lconn.homepage.widgets.activities.ActivitiesTodoList({ 
	...
	onSaved: function(){
		lconn.homepage.core.base.widgets.activitiesTodoList.ActivitiesTodoListHomepageClass.superclass.onSaved.apply(this);
